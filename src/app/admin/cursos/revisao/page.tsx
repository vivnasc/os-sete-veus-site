...
export default function RevisaoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1A1A2E] text-white/90 p-6 max-w-4xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <p className="text-xs text-white/40 uppercase tracking-widest mb-1">
          Revisao de Conteudo
        </p>
        <h1 className="text-3xl font-serif text-[#C9A96E]">Ouro Proprio</h1>
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded text-xs transition ${
                    selectedScript === key
                      ? "bg-[#C9A96E] text-[#1A1A2E] font-bold"
                      : review.status === "approved"
          ...
          {script && (
            <div>
              <div className="flex items-center gap-3 mb-4">
                <h2 className="text-xl font-serif text-[#C9A96E]">
              ...
              <div className="mt-4 p-3 rounded bg-white/5 border border-[#C9A96E]/30">
                <p className="text-xs text-[#C9A96E]/60 mb-1">Frase Final</p>
          ...
          {workbook && (
            <div>
              ...
              <div className="mb-4 p-3 rounded bg-white/5 text-xs text-white/40">
                <span className="text-[#C9A96E]">Tabela de registo: </span>
                {workbook.registoColumns.join(" | ")}
              </div>

              <div className="p-3 rounded bg-white/5 border border-[#C9A96E]/30">
                <p className="text-xs text-[#C9A96E]/60 mb-1">Ponte para o proximo modulo</p>
        ...
        <div>
          ...
          {yt && (
            <div>
              ...
              <div className="mt-4 p-3 rounded bg-white/5 border border-[#C9A96E]/30">
                <p className="text-xs text-[#C9A96E]/60 mb-1">Frase Final (ultimo frame)</p>
      ...
      <div className="mt-12 pt-8 border-t border-white/10">
        <h3 className="text-sm text-white/40 uppercase tracking-widest mb-3">
          Manual PDF
        </h3>
        <a
        ...
        <p className="text-xs text-white/30 mt-2">
          O PDF inclui o teu nome no rodape como licenca.
        </p>
      </div>
