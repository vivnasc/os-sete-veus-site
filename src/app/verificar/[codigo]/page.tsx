...
export const metadata: Metadata = {
  title: "Verificar Certificado — Sete Veus",
  description: "Verificacao publica de certificados de curso.",
};
        ...
        {result ? (
          ...
          <div className="bg-[#252547] border border-[#606070]/30 rounded-xl p-8">
            ...
            <p className="text-[#606070] text-sm">
              Verifica o codigo e tenta novamente.
            </p>
            <p className="text-[#606070] text-xs mt-4">
              Codigo verificado: {codigo}
            </p>
          </div>
        )}
      </div>
