...
const veus = [
  ...
  },
  {
    ...
    description: "Mãe, filha, mulher, profissional — são tantos os papéis que já não sabes o que sobra quando os tiras. Este véu convida-te a descobrir quem és por baixo de tudo.",
