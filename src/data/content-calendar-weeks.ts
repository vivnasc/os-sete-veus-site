...
export const professionalCarousels: ProfessionalCarousel[] = [
  {
    ...
    description: "Carrossel educativo para quem não conhece o projecto. Ideal para primeiro contacto.",
    slides: [
      ...
      { bg: "#f7f5f0", text: "#3d3630", accent: "#c9b896", title: "Os Sete Véus\ndo Despertar", body: "São 7 histórias de ficção\nonde te reconheces.\n\nCada história revela\num véu que usas\nsem saber.", footer: "" },
      { bg: "#3d3630", text: "#f7f5f0", accent: "#7a8c6e", title: "Não é um livro.\nÉ uma experiência.", body: "Lês. Respiras.\nReflectes. Escreves.\n\nCada capítulo tem pausas\nde respiração guiada\ne um diário pessoal.", footer: "", bgImage: "/prints/leitura-capitulo.jpeg" },
      { bg: "#f7f5f0", text: "#3d3630", accent: "#c9b896", title: "Os 7 Véus:", body: "1. Ilusão — a vida que não escolheste\n2. Medo — o que não fazes por medo\n3. Culpa — o castigo de quereres mais\n4. Identidade — a máscara que usas\n5. Controlo — o que seguras a mais\n6. Desejo — o que procuras fora\n7. Separação — o que separa de ti", footer: "", bgImage: "/prints/dashboard-membro.jpeg" },
      { bg: "#7a8c6e", text: "#f7f5f0", accent: "#ebe7df", title: "Começa pelo teste\ngratuito.", body: "3 minutos.\n7 perguntas.\nDescobre qual véu\nte esconde.", footer: "seteveus.space/recursos/teste", bgImage: "/prints/quiz-qual-veu.jpeg" },
    ],
    caption: "Já sentiste que a vida que tens não foi a que escolheste?\n\nOs Sete Véus do Despertar são 7 histórias de ficção onde te reconheces. Cada história revela um véu que usas sem saber.\n\nNão é um livro. É uma experiência: lês, respiras, reflectes, escreves.\n\nComeca pelo teste gratuito (3 min):\nseteveus.space/recursos/teste\n\n#OsSeteVeus #Autoconhecimento #FicçãoPsicológica #DesenvolvimentoPessoal #LeituraTransformadora",
    canvaSpecs: {
  ...
  },
  {
    ...
    description: "Carrossel comparativo que mostra a diferenca entre um livro normal e a experiência imersiva.",
    slides: [
      { bg: "#3d3630", text: "#f7f5f0", accent: "#c9b896", title: "Isto não é um livro.", body: "", footer: "", bgImage: "/images/mandala-7veus.png" },
      { bg: "#f7f5f0", text: "#3d3630", accent: "#7a8c6e", title: "Um livro normal:", body: "Lês do início ao fim.\nFechas.\nPassas ao proximo.", footer: "" },
      { bg: "#3d3630", text: "#f7f5f0", accent: "#c9b896", title: "A nossa experiência:", body: "Lês um capítulo.\nRespiras.\nEscreves no teu diário.\nSentes.\nSo depois avanças.", footer: "", bgImage: "/prints/leitura-capitulo.jpeg" },
      { bg: "#f7f5f0", text: "#3d3630", accent: "#7a8c6e", title: "Incluido:", body: "7 capítulos de ficção\nRespiração guiada\nDiario de reflexão\nComunidade anónima\nChatbot de apoio 24/7", footer: "", bgImage: "/prints/experiencia-funcionalidades.jpeg" },
      { bg: "#7a8c6e", text: "#f7f5f0", accent: "#ebe7df", title: "$29 USD / 1.885 MZN\nAcesso vitalicio.", body: "Começa hoje.", footer: "seteveus.space/comprar/espelhos" },
    ],
    caption: "Isto não é um livro. É uma experiência.\n\nA diferenca? Num livro les e fechas. Na nossa experiência, lês, respiras, escreves, sentes — e só depois avancas.\n\nInclui:\n— 7 capítulos de ficção\n— Respiração guiada\n— Diario de reflexão\n— Comunidade anónima\n— Chatbot de apoio\n\n$29 USD / 1.885 MZN. Acesso vitalicio.\n\nseteveus.space/comprar/espelhos\n\n#OsSeteVeus #ExperienciaImersiva #LeituraTransformadora",
    canvaSpecs: {
      dimensions: "1080x1080px (quadrado)",
  ...
  },
  {
    ...
    slides: [
      ...
      { bg: "#ebe7df", text: "#3d3630", accent: "#c9b896", title: "Bonus:", body: "Comunidade anónima\nonde partilhas reflexões\nsem julgamento.\n\nChatbot de apoio 24/7\ncom a voz da autora.", footer: "" },
      { bg: "#7a8c6e", text: "#f7f5f0", accent: "#ebe7df", title: "Começa hoje.\n$29 USD / 1.885 MZN", body: "Acesso vitalicio.\nSem pressa. Sem prazos.", footer: "seteveus.space/comprar/espelhos" },
    ],
    caption: "Como funciona a experiência Os Sete Véus?\n\n1. Escolhe o teu primeiro Espelho (já disponivel)\n2. Le ao teu ritmo — cada capítulo tem reflexão, respiração e diário\n3. Desbloqueia o que vem a seguir — histórias que só fazem sentido depois de viveres a primeira\n\nBonus: comunidade anónima + chatbot de apoio 24/7\n\n$29 USD / 1.885 MZN. Acesso vitalicio.\n\nseteveus.space/comprar/espelhos\n\n#OsSeteVeus #ExperienciaDigital #LeituraTransformadora #Autoconhecimento",
    canvaSpecs: {
      dimensions: "1080x1080px (quadrado)",
      fonts: "Título: Playfair Display / Corpo: Inter",
      colorPalette: ["#3d3630", "#f7f5f0", "#c9b896", "#7a8c6e", "#ebe7df"],
...

  {
    ...
    slides: [
      { bg: "#3d3630", text: "#f7f5f0", accent: "#c9b896", title: "Compraste\no livro físico?", body: "", footer: "Os 7 Véus do Despertar", bgImage: "/images/espelho-ilusao.png" },
      { bg: "#f7f5f0", text: "#3d3630", accent: "#c9b896", title: "Tens direito\não acesso digital\ngratuito.", body: "Tudo o que o livro\nte deu no papel,\nagora vives no ecrã.", footer: "" },
      { bg: "#3d3630", text: "#f7f5f0", accent: "#7a8c6e", title: "Preenche o formulário.", body: "2 minutos.\nNome, email e\n(se quiseres)\numa foto do livro.", footer: "seteveus.space/pedir-código" },
      { bg: "#f7f5f0", text: "#3d3630", accent: "#c9b896", title: "Recebes o código\nem até 24h.", body: "No teu email.\nPessoal. Intransmissivel.", footer: "" },
      { bg: "#7a8c6e", text: "#f7f5f0", accent: "#ebe7df", title: "O que ganhas:", body: "Leitura interactiva\nDiario reflexivo\nRespiracao guiada\nComunidade anónima\nChatbot de apoio 24/7", footer: "seteveus.space/pedir-código" },
    ],
    caption: "5 passos simples. Se já tens o livro físico, o acesso digital e teu por direito.\n\n1. Compraste o livro? Tens direito ao acesso digital gratuito.\n2. Preenche o formulário (2 minutos).\n3. Recebes o código em até 24h.\n4. O que ganhas: leitura interactiva, diário reflexivo, comunidade.\n\nPede aqui: seteveus.space/pedir-código\n\n#OsSeteVeus #AcessoDigital #LivroFisico #PedeOTeuCodigo #Autoconhecimento",
    canvaSpecs: {
      dimensions: "1080x1080px (quadrado)",
      fonts: "Título: Playfair Display / Corpo: Inter",
      colorPalette: ["#3d3630", "#f7f5f0", "#c9b896", "#7a8c6e", "#ebe7df"],
  ...
  },
  {
    ...
    slides: [
      ...
      { bg: "#f7f5f0", text: "#3d3630", accent: "#c9b896", title: "3. Há mais\npor descobrir.", body: "Os Espelhos e os Nos\nsao histórias exclusivas\nda plataforma.\n\nO livro físico e a porta.\nO digital é o caminho.", footer: "" },
      { bg: "#c9b896", text: "#3d3630", accent: "#f7f5f0", title: "Já tens o livro?\nO acesso é gratuito.", body: "2 minutos.\nUm formulário.\nUm código.", footer: "seteveus.space/pedir-código" },
    ],
    caption: "3 razões para activar o teu acesso digital:\n\n1. O diário reflexivo muda a forma como les — ler sem escrever e como olhar para um espelho de olhos fechados.\n\n2. Na comunidade Ecos, não estas sozinha — outras mulheres estão a atravessar os mesmos véus, anónimamente.\n\n3. Há mais por descobrir — os Espelhos e os Nos são histórias exclusivas da plataforma.\n\nJa tens o livro? O acesso é gratuito.\nseteveus.space/pedir-código\n\n#OsSeteVeus #AcessoDigital #ExperienciaDigital #Autoconhecimento",
    canvaSpecs: {
      dimensions: "1080x1080px (quadrado)",
      fonts: "Título: Playfair Display / Corpo: Inter",
      colorPalette: ["#3d3630", "#f7f5f0", "#c9b896", "#7a8c6e"],
