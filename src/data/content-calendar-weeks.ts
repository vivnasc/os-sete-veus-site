...
export const professionalCarousels: ProfessionalCarousel[] = [
  ...
  },
  {
    ...
    slides: [
      { bg: "#3d3630", text: "#c9b896", accent: "#f7f5f0", title: "Os 7 Espelhos\nque te revelam\nquem és de verdade.", body: "", footer: "Guarda esta publicação.", bgImage: "/images/mandala-7veus.png" },
      { bg: "#c9b896", text: "#3d3630", accent: "#f7f5f0", title: "Espelho 1\nIlusão", body: "A vida que construíste\nsem perguntar\nse era a que querias.", footer: "" },
      { bg: "#8b9b8e", text: "#f7f5f0", accent: "#ebe7df", title: "Espelho 2\nMedo", body: "Sabes o que queres.\nMas o medo\ndecide antes de ti.", footer: "" },
      { bg: "#c97070", text: "#f7f5f0", accent: "#ebe7df", title: "Espelho 3\nCulpa", body: "Castigas-te\npor quereres mais.\nComo se merecesses\nmenos.", footer: "" },
      { bg: "#7a7a9e", text: "#f7f5f0", accent: "#ebe7df", title: "Espelho 4\nIdentidade", body: "Usas uma máscara\nhá tanto tempo\nque esqueceste\no rosto.", footer: "" },
      { bg: "#5a7a8a", text: "#f7f5f0", accent: "#ebe7df", title: "Espelho 5\nControlo", body: "Seguras tudo.\nControlas tudo.\nE perdes tudo\no que não se deixa\nprender.", footer: "" },
      { bg: "#8a6a7a", text: "#f7f5f0", accent: "#ebe7df", title: "Espelho 6\nDesejo", body: "Procuras fora\no que só existe\ndentro.", footer: "" },
      { bg: "#6a6a6a", text: "#f7f5f0", accent: "#c9b896", title: "Espelho 7\nSeparação", body: "Separas-te de ti\npara pertencer\não mundo.", footer: "" },
  ...
  },
  {
    ...
    slides: [
      ...
      { bg: "#f7f5f0", text: "#3d3630", accent: "#c9b896", title: "\"Sai do modo\nautomático.\nNão sei para onde vou\nmas pelo menos\nestou acordada.\"", body: "", footer: "~ leitora anónima, Espelho 1" },
      { bg: "#3d3630", text: "#f7f5f0", accent: "#c9b896", title: "\"Chorei no banho.\nOutra vez.\nMas desta vez\nnão foi por tristeza.\nFoi por reconhecimento.\"", body: "", footer: "~ leitora anónima, Espelho 1" },
      { bg: "#ebe7df", text: "#3d3630", accent: "#c9b896", title: "\"O meu marido\nperguntou: estás bem?\nE eu disse que sim.\nAutomaticamente.\"", body: "", footer: "~ leitora anónima, Espelho 1" },
