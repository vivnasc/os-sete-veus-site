...
export const professionalCarousels: ProfessionalCarousel[] = [
  ...
  },
  {
    ...
    slides: [
      ...
      { bg: "#f7f5f0", text: "#3d3630", accent: "#7a8c6e", title: "1. Leitura em\n4 níveis", body: "Cada véu pode ser lido\nem 4 profundidades:\ndesde uma leitura acessível\naté práticas de\ntransformação pessoal.", footer: "", bgImage: "/prints/7veus-3niveis-portrait.png" },
  ...
  },
  {
    ...
    slides: [
      ...
      { bg: "#f7f5f0", text: "#3d3630", accent: "#c9b896", title: "3. 4 níveis\nde profundidade.", body: "Semente — leitura acessível\nRaiz — contexto filosófico\nJornada — autodescobertas\nProfundidade — transformação\n\nO livro físico é a porta.\nO digital é o caminho.", footer: "" },
  ...
  {
    id: "carousel-leitura-4-niveis",
    title: "Um livro que se lê de 4 formas diferentes",
    description: "Carrossel sobre os 4 níveis de leitura da experiência digital. Diferencial único.",
    slides: [
      { bg: "#3d3630", text: "#f7f5f0", accent: "#c9b896", title: "Um livro que se lê\nde 4 formas diferentes.", body: "", footer: "Os 7 Véus do Despertar", bgImage: "/images/mandala-7veus.png" },
      { bg: "#f7f5f0", text: "#3d3630", accent: "#c9b896", title: "Nível 1: Semente", body: "Leitura acessível.\nResumida em linguagem clara.\nPerguntas de orientação.\nExemplos concretos.\n\nPara quem quer começar\ndevagar.", footer: "" },
      { bg: "#3d3630", text: "#f7f5f0", accent: "#7a8c6e", title: "Nível 2: Raiz", body: "Contexto filosófico.\nNotas que explicam\nconceitos como Ubuntu,\nanattā, fanā.\n\nLigações a tradições\nbudistas, africanas, sufis.", footer: "" },
      { bg: "#f7f5f0", text: "#3d3630", accent: "#c9b896", title: "Nível 3: Jornada", body: "Autodescobertas.\nCrenças para mapear.\nSinais do véu na tua vida.\nGuias de reflexão pessoal.", footer: "" },
      { bg: "#3d3630", text: "#f7f5f0", accent: "#c9b896", title: "Nível 4: Profundidade", body: "Transformação pessoal.\nMáscaras que usas.\nSinais do teu véu dominante.\nExercícios de escrita\ncom processo e tempo.", footer: "" },
      { bg: "#7a8c6e", text: "#f7f5f0", accent: "#ebe7df", title: "Já tens o livro físico?\nEstes 4 níveis esperam-te\nno digital.", body: "Gratuito. 2 minutos.", footer: "seteveus.space/pedir-codigo" },
    ],
    caption: "Sabias que Os 7 Véus do Despertar pode ser lido de 4 formas diferentes na plataforma digital?\n\nNível 1 — Semente: leitura acessível, exemplos concretos\nNível 2 — Raiz: contexto filosófico, tradições budistas, africanas, sufis\nNível 3 — Jornada: autodescobertas, sinais do véu na tua vida\nNível 4 — Profundidade: transformação pessoal, exercícios de escrita\n\nJá tens o livro físico? Estes 4 níveis esperam-te no digital. Gratuito.\nseteveus.space/pedir-codigo\n\n#OsSeteVeus #4Niveis #ExperienciaDigital #LivroFilosofico #PedeOTeuCodigo #Autoconhecimento",
    canvaSpecs: {
      dimensions: "1080x1080px (quadrado)",
      fonts: "Título: Playfair Display / Corpo: Inter",
      colorPalette: ["#3d3630", "#f7f5f0", "#c9b896", "#7a8c6e", "#ebe7df"],
