...
export const reelScripts: ReelScript[] = [
  {
    ...
    scenes: [
      ...
      "CENA 6 (25-30s): CTA final sobre fundo escuro: \"Ha mais para ti. Teste gratuito na bio.\"",
    ],
    cta: "Ha mais para ti. Teste gratuito na bio.",
