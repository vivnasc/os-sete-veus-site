...
export const OURO_PROPRIO_SCRIPTS: Record<string, LessonScript> = {
  ...
  m1c: {
    ...
    revelacaoPadrao:
      "O dinheiro nao e abstracto. O teu corpo sabe disso mesmo que a tua mente finja que e so matematica. Cada decisao financeira passa pelo corpo primeiro. E o corpo guarda tudo: a vez que ouviste os teus pais a discutir por causa de dinheiro. A vez que pediste algo e te disseram que nao havia. A vez que viste vergonha no rosto de alguem que amas por causa de uma conta. Essas memorias nao ficaram na cabeca — ficaram nos musculos, na respiracao, na postura. E agora, cada vez que o dinheiro aparece, o corpo responde primeiro. Antes da razao. Antes da calculadora. Antes de ti. Se nao sabes o que o teu corpo sente quando o dinheiro aparece, nao estas a tomar decisoes financeiras. Estas a reagir a memorias antigas.",
    gestoConsciencia:
      "Na proxima vez que pagares algo — qualquer coisa, um cafe, uma conta, uma compra online — para um segundo antes. Poe atencao no corpo. Onde esta a tensao? Onde esta o alivio? Ha aperto ou ha expansao? Respira. Nota. Nao mudes nada. So nota. Faz isto tres vezes esta semana. Ao terceiro dia, vais comecar a reconhecer um padrao que sempre esteve la.",
    fraseFinal:
  ...
  m3a: {
    ...
    gestoConsciencia:
      "Pensa na ultima vez que disseste nao a alguma coisa por vergonha financeira. Escreve o que aconteceu. Depois escreve: o que teria acontecido se eu tivesse dito a verdade? Nao para te obrigares a ser transparente com toda a gente — mas para veres o custo do silencio. Para veres quanto espaco a vergonha te roubou.",
    fraseFinal:
  ...
  m3b: {
    ...
    gestoConsciencia:
      "Escreve numa folha, sem censura: o que eu quero e que me da vergonha de querer. Pode ser um valor. Uma casa. Uma viagem. Um salario. Uma vida diferente. Escreve tudo. Depois le em voz alta. E nota o que acontece no corpo. Se a vergonha aparecer, nao a empurres. Olha para ela. Ela esta ali ha muito tempo. Merece ser vista.",
    fraseFinal:
  ...
  m4c: {
    ...
    revelacaoPadrao:
      "A dificuldade de receber nao e educacao — e proteccao. Algures aprendeste que receber te coloca em posicao de vulnerabilidade. Que quem da tem poder. Que ficar a dever e ficar em perigo. Talvez na tua familia receber vinha com condicoes. Talvez a generosidade era uma moeda de troca. Talvez alguem te deu algo e depois usou isso contra ti. O corpo aprendeu: receber nao e seguro. E agora, cada vez que algo bom chega, a tua primeira reaccao nao e prazer — e calcular o custo. Isto estende-se ao dinheiro de forma directa: se nao consegues receber um presente sem angustia, como vais receber um aumento? Uma proposta melhor? Uma oportunidade que nao pediste? Receber e uma capacidade. E pode estar atrofiada.",
    gestoConsciencia:
  ...
  m5c: {
    ...
    perguntaInicial:
      "E se gastar dinheiro em ti nao fosse egoismo — mas um acto de resistencia contra tudo o que te ensinou que o teu lugar e por ultimo?",
    situacaoHumana:
    ...
    revelacaoPadrao:
      "Quando uma mulher investe em si, o mundo a sua volta muda. Nao por magia — por posicionamento. Uma mulher que se leva a serio com o dinheiro esta a dizer: eu sou prioridade na minha propria vida. E isto incomoda. Incomoda quem beneficia de mulheres que se colocam por ultimo. Incomoda os sistemas que precisam que sejas a que da, a que sacrifica, a que espera. Investir em ti nao e egoismo — e uma afirmacao. E um acto que diz: recuso-me a ser a ultima da fila na minha propria existencia. Nao es frívola por querer crescer. Nao es egoista por te escolher. Es alguem que finalmente percebeu que nao podes dar o que nao tens. E que o que tens comeca pelo que decides dar a ti mesma.",
    gestoConsciencia:
      "Pensa naquilo que tens adiado investir em ti. Escreve o que e. Escreve o custo. E depois escreve: o custo de continuar a adiar e... Preenche com honestidade. Nao e sobre forcares a compra. E sobre veres com clareza o preco de te pores sempre em ultimo lugar.",
    fraseFinal:
  ...
  m6b: {
    ...
    situacaoHumana:
      "Ha mulheres que ficam em relacoes nao por amor — mas por matematica. Porque fizeram as contas e nao batem. Porque o apartamento esta no nome dele. Porque a poupanca e partilhada mas so um tem acesso. Porque se sair, vai para onde? Com que dinheiro? Ninguem diz isto em voz alta. A conversa com as amigas e sobre a relacao. Sobre sentimentos. Sobre se ainda ha amor. Mas a noite, sozinha, a conta que se faz nao e emocional — e financeira. Quanto custa a minha liberdade? E a resposta, as vezes, e: mais do que tenho. Entao fica. Nao porque queira — mas porque nao pode. E cada dia que fica por nao poder, perde um bocado de si mesma. Nao de uma vez. Aos poucos. Como um gotejamento.",
    revelacaoPadrao:
      "A dependencia financeira nao prende o corpo — prende a vontade. Nao precisas de estar trancada para nao sair. Basta nao ter para onde ir. E isto e o mais invisivel das prisoes: nao tem grades. Tem contas. Tem rendas. Tem a escola das criancas. Tem a vergonha de voltar para casa dos pais. O medo que se sente quando se depende financeiramente de alguem nao e so medo de ficar sem dinheiro. E medo de ficar sem identidade. Porque quando todo o teu mundo material depende de outra pessoa, sair nao e so uma mudanca — e um colapso. E o sistema sabe disto. E construido para que muitas mulheres fiquem exactamente aqui: com o suficiente para nao sair, mas nunca com o suficiente para se sentir livres.",
    gestoConsciencia:
  ...
  m7a: {
    ...
    gestoConsciencia:
      "Completa esta frase: se tivesse mais dinheiro, finalmente poderia... Depois olha para o que escreveste. E pergunta: sera que preciso de mais dinheiro para isso? Ou preciso de mais permissao? Mais coragem? Mais presenca? Nao e para desvalorizar o dinheiro — e para perceber o que realmente estás a pedir quando pedes mais.",
    fraseFinal:
  ...
  m7b: {
    ...
    situacaoHumana:
      "Estiveste meses a poupar. Com disciplina, com cuidado, com esforco. A conta crescia. E comecaste a sentir-te estranha. Nao confortavel — estranha. Como se aquele dinheiro na conta nao fosse teu. Como se houvesse uma data de validade invisivel. Depois, sem razao clara, gastaste. Uma compra grande. Uma viagem que nao tinhas planeado. Uma oferta excessiva. Ou entao pequenas fugas: compras online de madrugada, saidas que nao precisavas, coisas que ja nem te lembras. Quando viste a conta de novo, estava quase onde comecou. E sentiste duas coisas ao mesmo tempo: frustacao e alivio. Frustacao porque perdeste o que juntaste. Alivio porque, de alguma forma estranha, estar sem dinheiro e mais familiar do que ter.",
    revelacaoPadrao:
      "A sabotagem financeira nao e falta de disciplina. E um corpo que regressa ao que conhece. Se cresceste com pouco, a abundancia pode ser desconfortavel. Se associas dinheiro a conflito, ter dinheiro pode sentir-se como estar em perigo. Se acreditas, la no fundo, que nao mereces ter — o corpo encontra formas de garantir que nao tens. E faz isto de forma brilhante: com decisoes que parecem razoaveis no momento mas que, vistas de longe, formam um padrao claro. Ganhas e perdes. Sobes e desces. Constróis e destróis. Nao porque nao saibas gerir dinheiro — mas porque alguma parte de ti acredita que nao o devias ter. A sabotagem nao e o problema. E o sintoma. E o que esta por baixo e uma crenca sobre o teu lugar no mundo.",
    gestoConsciencia:
      "Olha para o teu historico financeiro dos ultimos dois anos. Houve momentos em que tinhas mais e depois perdeste? Houve um padrao de subir e descer? Escreve os momentos de queda. Nao os numeros — as circunstancias. O que estavas a sentir? O que aconteceu antes? Nao para te culpares — para veres o padrao. Porque o padrao so se repete enquanto nao o ves.",
    fraseFinal:
  ...
  m8a: {
    ...
    gestoConsciencia:
      "Pega num papel e divide-o ao meio. Na esquerda, escreve: o que o meu dinheiro paga agora. Na direita: o que eu queria que o meu dinheiro financiasse. Preenche as duas. Nao importa se e possivel agora. Importa ver a distancia entre onde estas e onde queres ir. Porque a distancia nao e um problema — e uma direcao. E ter uma direcao ja e diferente de sobreviver.",
    fraseFinal:
