...
export const veu7Niveis: NivelCapitulo[] = [
  {
    ...
    notas_contextuais: [
      ...
      {
        paragrafo_indice: 12,
        texto: 'No Taoismo, o wu wei (não-acção) não é passividade. E acção alinhada com o fluxo da vida, sem a interferência do desejo de controlar o resultado. O "caminhar sem precisar de chegar" é a expressão viva do wu wei.',
      },
      {
        paragrafo_indice: 20,
  ...
  },
  {
    ...
    notas_contextuais: [
      ...
      {
        paragrafo_indice: 12,
        texto: 'No Zen, diz-se: "antes da iluminação, corta lenha é carrega água; depois da iluminação, corta lenha é carrega água." A acção é a mesma. O que muda é a qualidade de presença. A integração não altera o mundo — altera a forma como o habitas.',
      },
      {
        paragrafo_indice: 18,
        texto: 'O conceito de Brahman no Advaita Vedanta aponta para a realidade una que subjaz a todas as formas. Atman (o individual) e Brahman (o universal) não são dois — são o mesmo visto de angulos diferentes. A separação entre "eu" e "o mundo" é o último véu.',
      },
    ],
    ...
    crencas_a_mapear: [
      ...
      'O meu corpo é o meu quotidiano são obstáculos ao despertar, não veiculos dele.',
      ...
      'A matéria é inferior ao espírito — é preciso de transcende-la para ser livre.',
    ],
    sinais_do_veu: [
    ...
    guiao_reflexao: [
      'Escolhe um gesto quotidiano que fazes sem pensar — lavar as mãos, abrir uma porta, caminhar até ao trabalho. Amanha, faz esse gesto com atenção total. Depois escreve o que sentiste. O que muda quando o sagrado desce ao gesto mais simples?',
      ...
      'Imagina que o espírito é a matéria te escrevem uma carta conjunta. Não são dois — são um só. O que te dizem? O que te pedem que deixes de separar?',
    ],
    ...
    veu_dominante_sinais: [
      'Tens uma vida dupla silenciosa — o teu "eu espiritual" é o teu "eu do mundo" não se conhecem, é tu gastas energia enorme a gerir a fronteira entre eles.',
      'Quando estás em momentos de profundidade interior, a vida prática parece-te trivial é quase indigna. Quando estás imersa no quotidiano, sentes nostalgias do silêncio como quem sente saudades de casa.',
      'Classificas automaticamente as experiências em "espirituais" e "não-espirituais" — é essa classificação determina o valor que lhes das, o tempo que lhes dedicas, a atenção que lhes ofereces.',
      'Tens dificuldade em aceitar que cozinhar, limpar, fazer amor, discutir uma conta é trabalhar sob pressao possam ser tão sagrados como qualquer oração ou meditação — é essa dificuldade é a dualidade a operar em tempo real.',
    ...
    mensagem_central: 'Não há dois mundos. Nunca houve. Há um único tecido — é tu és feita dele. O sagrado não mora num templo que visitas de vez em quando. Mora nas tuas mãos quando tocam, nós teus olhos quando veem, no teu peito quando respira. Cada vez que separaste o espírito da matéria, dividiste-te a ti mesma ao meio — é essa divisão é o cansaço que sentes há tanto tempo. Não é cansaço do corpo. Não é cansaço da alma. E o cansaço de manter duas casas quando só existe uma. O convite deste capítulo não é que transcendas a matéria nem que abandones o espírito. E que deixes de fingir que são coisas diferentes. A água que bebes é sagrada. A fadiga que sentes é sagrada. O riso é o choro é o silêncio entre eles — tudo é o mesmo mistério a desdobrar-se. Quando parares de separar, vais perceber que nunca precisaste de unir nada. Porque nunca esteve separado.',
    guiao_escrita: {
      contexto: 'Este exercício convida-te a dissolver a fronteira entre espírito é matéria — não com ideias, mas com atenção directa ao que já é uno na tua experiência.',
      passos: [
        'Escolhe um gesto absolutamente mundano que vas fazer nas próximas horas — lavar a louça, tomar banho, caminhar até um sítio, comer uma refeição. Antes de o fazeres, escreve como normalmente vives esse gesto: com que nível de atenção, com que estado interior, com que pressa.',
  ...
  },
  {
    ...
    perguntas_orientadoras: [
      'O que resta em ti agora — depois de tudo o que olhaste, sentiste é soltaste ao longo desta jornada?',
      'Consegues sentir, nem que seja por um instante, que não há nada a fazer, nada a corrigir, nada a alcançar — é que isso não é derrota, é chegada?',
    ...
    exemplos_concretos: [
      ...
      },
      {
        ...
        texto: 'Sais de casa é o mundo é o mesmo — barulho, trânsito, gente apressada. Mas algo mudou em ti. Não é que vejas o mundo de forma diferente. E que já não precisas que o mundo seja diferente. Essa aceitação sem resignação, essa presença sem condições — é o que resta quando o último véu repousa.',
      },
    ],
    notas_contextuais: [
      {
      ...
      {
        paragrafo_indice: 12,
        texto: 'O fana no sufismo descreve a aniquilação do eu individual na presença divina. Mas Rumi acrescentava: depois do fana há o baqa — a permanência. Não se trata de desaparecer. Trata-se de regressar ao mundo com o eu transparente, sem pesar, sem separação. O centro não é fuga do mundo. E o ponto a partir do qual o mundo se torna habitável.',
      },
      {
        paragrafo_indice: 20,
        texto: 'No Ubuntu, a realização individual nunca é solitária. O centro que o texto descreve não é retiro do outro — é a descoberta de que no mais fundo de mim vive o mesmo silêncio que vive no mais fundo de ti. Quando dois seres se encontram nesse ponto, o que existe entre eles não precisa de nome. E reconhecimento.',
      },
    ],
    ...
    crencas_a_mapear: [
      ...
      'Se eu realmente chegasse ao centro, a minha vida teria de ser radicalmente diferente do que e.',
      'Este silêncio que sinto as vezes não é suficiente — deve haver algo mais profundo que ainda não alcancei.',
      'Não mereco a paz que sinto — não fiz o suficiente para a merecer.',
      'Se largar a procura, perco a única coisa que me define: o caminho.',
    ],
    sinais_do_veu: [
      'Sentes momentos de paz profunda — é imediatamente a mente diz que não pode durar, que não é real, que vais perde-la.',
      ...
      'Tens dificuldade em aceitar que o centro sempre esteve aqui — porque isso significaria que todo o sofrimento da busca era, ao mesmo tempo, necessário é desnecessário.',
      'Quando a quietude chega, tens medo de que não estejas a "aproveita-la bem" — é esse medo é o último véu.',
      'Identificas-te com a jornada ao ponto de não saberes quem és sem ela — é percebes que até o papel de "buscadora" pode ser um véu.',
    ],
    guiao_reflexao: [
      'Senta-te em silêncio. Não medites. Não reflictas. Não procures nada. Fica. Quando o silêncio se tornar insuportável ou luminoso — não importa qual — abre os olhos é escreve o que encontraste. Não o que pensaste. O que encontraste.',
      'Escreve uma carta a ti mesma — não a ti de há cinco anos, nem a ti do futuro. A ti, agora. Neste corpo. Nesta vida. Com tudo o que viveste é tudo o que soltaste. O que precisas de te dizer que ainda não disseste?',
      'Lê os teus escritos ao longo desta jornada — desde o primeiro capítulo até aqui. Depois fecha tudo é escreve uma única frase. A frase que fica. A que não precisa de explicação. A que, daqui a dez anos, ainda será verdadeira.',
    ],
    ...
    veu_dominante_sinais: [
      'Sentes que a tua vida inteira se organizou em torno de uma grande separação — entre quem és é quem devias ser, entre onde estás é onde devias estar — é mesmo agora, neste ponto da jornada, essa divisão persiste como um eco subtil.',
      'Quando te aproximas de momentos de unidade — em que tudo parece fazer sentido, em que o dentro é o fora se tocam — a mente entra em acção imediata para catalogar, compreender ou preservar a experiência, é nesse gesto separa-te outra vez daquilo que estavas a viver.',
    ...
    guiao_escrita: {
      ...
      passos: [
        ...
        'Agora recorda os sete véus — illusao, medo, culpa, identidade, controlo, desejo, dualidade. Para cada um, escreve uma única palavra que te vem quando pensas nele. Não expliques. Apenas uma palavra por véu. Olha para as sete palavras lado a lado.',
        'Escreve uma carta ao ser que eras quando começaste está leitura. Não a adores. Não a corrijas. Fala-lhe como quem fala a alguém que ama é que sempre esteve a fazer o melhor que sabia. Diz-lhe o que descobriste — não sobre o mundo, mas sobre ela.',
        'Agora escreve uma única frase — a frase que, se fosse a única coisa que ficasse de toda está jornada, bastaria. A frase que levarias contigo para uma ilha deserta, não como ensinamento, mas como companhia.',
        'Fecha o caderno. Respira. Olha a tua volta. O mundo não mudou. Mas repara: alguma coisa em ti repousa agora de uma forma que não repousava antes. Não precisas de a nomear. Ela já sabe o que e.',
      ],
