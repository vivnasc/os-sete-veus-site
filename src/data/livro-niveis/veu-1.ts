...
export const veu1Niveis: NivelCapitulo[] = [
  {
    ...
    veu_dominante_sinais: [
      ...
      'Passas mais tempo a pensar sobre quem és do que a viver quem és. A reflexão sobre a identidade tornou-se um loop: nunca chegas a uma resposta porque a pergunta alimenta-se de si mesma.',
      'Este tema — agarrar-te ao que já foste — aparece repetidamente nas tuas relações, no trabalho, na forma como falas de ti. É o fio que liga tudo. Não é um problema pontual. É o padrão de fundo.',
      'Tens dificuldade em estar com pessoas que te conheceram numa fase anterior da vida. Sentes que te veem como eras e não como és — e isso sufoca. Mas a verdade é que tu também não sabes bem como és agora.',
      'Há uma tensão constante entre quem sentes que és por dentro e quem mostras por fora. Não porque mintas, mas porque o que sentes por dentro não cabe em nenhum nome que conheças.',
    ],
    mensagem_central: 'Este capítulo não te pede que descubras quem és. Pede-te algo mais radical e mais gentil: que pares de procurar uma resposta fixa. Os rótulos que carregas — o teu nome, a tua história, os papéis que desempenhas — não são mentira, mas também não são toda a verdade. São molduras, e tu és maior do que qualquer moldura. Há algo em ti que já existia antes do primeiro rótulo e que vai continuar depois do último. Não precisas de o nomear. Precisas apenas de o sentir. E este capítulo é um convite a esse sentir — sem pressa, sem mapa, sem destino.',
    guiao_escrita: {
      contexto: 'Este exercício convida-te a encontrar quem és por baixo dos rótulos. Não há respostas certas — há apenas o que emerge quando paras de procurar.',
      passos: [
        'Fecha os olhos. Respira três vezes, lentamente. Nota o que sentes no corpo antes de escrever — tensão, calma, vazio, peso.',
        'Pensa na última vez que alguém te perguntou "quem és tu?" e escreve o que respondeste. Palavra por palavra, como saiu.',
        ...
        'Lê o que escreveste. Sublinha a frase que mais te surpreendeu. Essa frase é o teu espelho de hoje.',
      ],
  ...
  },
  {
    ...
    exemplos_concretos: [
      {
        ...
        texto: 'Pensa num dia em que te sentiram elogiar por algo que fizeste "no automático" — sem prazer, sem presença. O elogio foi real, mas houve uma parte de ti que não se reconheceu nele. Esse desencontro é o que o capítulo chama de "tensão entre persona e Self".',
      },
      {
        contexto: 'Nas relações',
        texto: 'Imagina que sempre foste vista como "a pessoa forte" do grupo. Um dia sentes-te frágil, mas não sabes como mostrá-lo sem "desapontar" os outros. Esse medo é uma máscara que se tornou prisão.',
      },
    ],
    notas_contextuais: [
      {
      ...
      {
        paragrafo_indice: 5,
        texto: 'Em muitas culturas africanas, as máscaras rituais não escondem — revelam. Quem as veste torna-se canal de uma força maior. Repara na diferença: no Ocidente a máscara oculta; em África, a máscara pode ser portal.',
      },
      {
        paragrafo_indice: 15,
        texto: 'O conceito akan de Sankofa ("para avançar, é preciso regressar") aparece aqui como antidoto ao medo do vazio. O vazio não é falha — é memória a chamar, convite a resgatar o que ficou esquecido.',
      },
      {
        paragrafo_indice: 20,
    ...
    crencas_a_mapear: [
      'Se mostrar quem realmente sou, vão rejeitar-me.',
  ...
  },
  {
    ...
    notas_contextuais: [
      {
        paragrafo_indice: 3,
        texto: 'O texto vai apresentar três "mapas" do eu: Ocidente (eu como núcleo), Oriente (eu como miragem) e África (eu como relação). Nenhum basta sozinho — mas juntos desenham paisagem mais ampla.',
      },
      {
        paragrafo_indice: 8,
      ...
      {
        paragrafo_indice: 18,
        texto: 'Laozi (Taoismo): "O nome que pode ser nomeado não é o nome eterno." Tudo o que tentamos definir já deixou de ser o que era. Fixar identidade é tentar prender água nas mãos.',
      },
      {
        paragrafo_indice: 24,
        texto: 'Mbiti: "eu sou porque nós somos." Esta frase não é slogan — é modo de existir. A identidade não se ergue em isolamento: respira no vínculo.',
      },
      {
        paragrafo_indice: 30,
    ...
    // Jornada de autodescobertas
    crencas_a_mapear: [
      'Há uma verdade única sobre quem eu sou — só preciso de a encontrar.',
    ...
    sinais_do_veu: [
      'Saltas de tradição em tradição à procura da "resposta certa" sobre quem és.',
    ...
    guiao_escrita: {
      ...
      passos: [
        ...
        'Escreve no topo da página: "O que penso que sou." Por baixo, escreve tudo o que te vem à cabeça — papéis, qualidades, defeitos, histórias. Não filtres. Despeja.',
        'Agora escreve num novo espaço: "O que sinto que sou." Fecha os olhos um momento antes de começar. Esquece as palavras do passo anterior. Vai ao corpo. Que sensação aparece? Que imagem? Que cor? Escreve a partir daí, mesmo que não faça sentido lógico.',
        ...
        'Lê os três textos em sequência. Repara no que se repete. Repara no que se contradiz. Repara no que te surpreende. Escreve uma última frase que comece com: "Talvez eu seja..."',
      ],
      tempo_sugerido: '25 minutos',
      nota_final: 'Não tentes que os três textos façam sentido juntos. A beleza está na tensão entre eles. O que és não precisa de ser coerente — precisa de ser verdadeiro.',
    },
  },
]
