...
export const veu4Niveis: NivelCapitulo[] = [
  {
    capitulo_numero: 13,
    resumo_acessivel: [
    ...
    exemplos_concretos: [
      {
        ...
        texto: 'Imagina que há anos es "a pessoa forte" da família — quem resolve, quem ouve, quem nunca pede. Um dia sentes-te esgotada é percebes que ninguém te pergunta como estás. O capítulo pergunta: será que o teu dar criou uma prisão para ambos os lados?',
      },
      {
        contexto: 'Na reflexão pessoal',
        texto: 'Pensa num momento em que disseste "sim" quando querias dizer "não". O que te impediu? Medo de desapontar? De perder amor? O texto chama-lhe "amor preso em permanência" — quando o gesto livre se torna obrigação.',
      },
    ],
    notas_contextuais: [
      {
      ...
      {
        paragrafo_indice: 12,
        texto: 'O Taoismo ensina que yin é yang se complementam: dar é receber, força é fragilidade, acção é repouso. Quando só há dar, o equilíbrio parte-se. Dizer "não" pode ser o gesto que restaura o fluxo.',
      },
      {
        paragrafo_indice: 20,
        texto: 'O "cuidado que aprisiona" é codependência: um padrão onde quem da precisa de ser necessário é quem recebe precisa de ser cuidado. Ambos ficam presos num gesto que já não é livre.',
      },
    ],
    termos_destacados: ['Ubuntu', 'Taoismo', 'despertar', 'veu'],

    // Jornada de autodescobertas
    crencas_a_mapear: [
      'Se eu não cuidar de tudo, ninguém cuida.',
      'Dizer não a quem amo é uma forma de abandono.',
      'O meu valor vem daquilo que faco pelos outros, não daquilo que sou.',
      'Se eu parar de dar, vão deixar de me amar.',
      'Ser forte é nunca precisar de ajuda.',
    ],
    sinais_do_veu: [
      'Sentes um cansaço que não passa com descanso — porque não é do corpo, é do papel que carregas.',
      'Quando alguém te pergunta "como estás?", respondes automaticamente "bem" — é já nem sabes se é verdade.',
      'Dizes "sim" com a boca e "não" com o corpo: tens dores, tensão, insónia, mas continuas a cuidar de todos.',
      'Sentes ressentimento por quem ajudas — é depois culpa pelo ressentimento.',
      'Não te lembras da última vez que alguém cuidou de ti sem que tivesses de pedir.',
    ],
    guiao_reflexao: [
    ...
    // Camada profunda
    mascaras: [
      'A incansavel — a que nunca descansa sem sentir culpa. Para ela, parar é desistir. O valor está no esforço, nunca no repouso. Mesmo quando o corpo implora tregua, ela encontra mais uma coisa para fazer, mais alguém para servir, mais um gesto para provar que está viva.',
      'A imprescindivel — a que se define pelo que faz pelos outros. Se ninguém precisa dela, ela desaparece. O esforço não é escolha — é a única forma de existir. Sem o papel de quem sustenta, não sabe onde pousar os pés.',
      'A que carrega tudo em silêncio — a que nunca pede, nunca reclama, nunca mostra o peso. O esforço dela é invisível porque ela o tornou natural. Há tanto tempo que carrega sozinha que já confunde resistência com força.',
      'A reparadora — a que está sempre a tentar consertar o que se partiu: relações, pessoas, situações. Descansa só quando tudo está "bem" — é como nada está nunca completamente bem, o descanso nunca chega. O esforço de reparar é o único lugar onde se sente útil.',
    ],
    veu_dominante_sinais: [
      'Os teus dias organizam-se em torno do que precisas de fazer pelos outros — é o tempo para ti aparece sempre no fim, quando já não sobra energia. O esforço pelos outros é automático; o repouso para ti é um luxo que nunca chega.',
      ...
      'Medes o teu valor pelo que produzes num dia. Um dia sem tarefas concluidas é um dia perdido. Há uma contabilidade interior que nunca fecha a teu favor.',
      'Mesmo nas ferias ou nós dias livres, há uma parte de ti que calcula o próximo passo, o próximo projecto. O descanso é sempre provisório — prepara-se para o próximo esforço.',
      'Quando alguém a tua volta para é simplesmente está, sentes desconfiança ou até desprezo suave — como se a quietude fosse preguiça disfarçada.',
    ],
    mensagem_central: 'Há um lugar em ti que confunde esforço com dignidade. Que acredita, no fundo, que só mereces existir se estiveres a dar, a fazer, a sustentar. Esse lugar não nasceu do nada — foi construido por anos de recompensa pelo sacrifício é silêncio diante do cansaço. Mas há uma verdade que o esforço constante tenta abafar: tu não precisas de te gastar para merecer ficar. O amor que exige que te dissolvas não é amor — é consumo. E o primeiro gesto de coragem não é fazer mais, é parar. Parar não como desistência, mas como acto radical de presença. Quando paras, o que surge não é vazio — é o som do teu próprio corpo a dizer-te, finalmente, o que precisa.',
    guiao_escrita: {
      contexto: 'Este exercício convida-te a olhar para os papéis que desempenhas é a sentir o peso real que carregas — não para os julgares, mas para reconheceres o esforço que te custa existir assim.',
      passos: [
        'Senta-te num lugar onde ninguém te interrompa. Fecha os olhos durante dois minutos. Sente o peso do teu corpo — não como metáfora, como sensação física. Onde pesa mais?',
        'Abre os olhos é escreve no topo da página: "Aquilo que carrego." Faz uma lista de tudo o que sustentas — tarefas, pessoas, preocupações, papéis. Não filtres. Deixa a lista crescer até sentires que está completa.',
        'Agora, ao lado de cada item, escreve uma única palavra que descreva o que sentes ao carrega-lo. Pode ser: obrigação, amor, medo, hábito, culpa, orgulho. Não há respostas certas.',
        'Escolhe um item da lista — o que te pesa mais neste momento. Escreve-lhe uma carta curta: "Eu carrego-te porque..." Deixa a frase completar-se sozinha, sem a controlares.',
        'Termina escrevendo: "Se eu te pousasse, o que restaria de mim?" Não respondas com a cabeça. Responde com o que sentes no peito ao escrever a pergunta.',
      ],
      tempo_sugerido: '25 a 35 minutos',
      nota_final: 'Não precisas de resolver nada. Este exercício não é para largares o que carregas — é para veres, talvez pela primeira vez, o que te custa. Ver é o primeiro gesto de liberdade.',
    },
  },
  {
    capitulo_numero: 14,
    ...
    perguntas_orientadoras: [
      ...
      'O teu "autocuidado" é presença genuína ou retirada disfarçada?',
      'O que precisas de deixar morrer em ti para que algo novo possa nascer?',
    ],
    exemplos_concretos: [
      {
        contexto: 'No quotidiano',
        texto: 'Imagina que continuas a ir trabalhar, a cozinhar, a responder mensagens — mas há meses que não sentes nada. Não é depressão no sentido clínico. E o que o capítulo chama de "permanência sem presença": o corpo está, a alma não.',
      },
    ],
    notas_contextuais: [
      {
        paragrafo_indice: 4,
        texto: 'Winnicott, psicanalista, distinguia o "verdadeiro self" do "falso self" — uma estrutura que cumpre o que o mundo espera enquanto o ser real se esconde. O texto usa este conceito para descrever a ausência crónica disfarçada de funcionalidade.',
      },
      {
        paragrafo_indice: 10,
        texto: 'Byung-Chul Han fala da "violência da positividade": a exigência de ser produtivo, optimista é disponível a toda a hora. O esgotamento não é fraqueza — é consequência de um sistema que não para.',
      },
      {
        paragrafo_indice: 16,
        texto: 'Clarissa Pinkola Estes descreve a mulher separada do instinto — aquela que esqueceu como ouvir o corpo, os sonhos, a voz interior. O "reaparecimento" de que o capítulo fala é esse regresso ao instinto.',
      },
    ],
    termos_destacados: ['despertar', 'veu', 'identidade'],

    // Jornada de autodescobertas
    crencas_a_mapear: [
      'Se eu parar, tudo desmorona.',
      'Estar cansada é sinal de fraqueza, não de que algo precisa mudar.',
      'A minha ausência interior é temporaria — vai passar se eu continuar a funcionar.',
      'Chorar os papéis que perdi é ingratidao por tudo o que tenho.',
      'Não tenho direito de me retirar quando há pessoas que dependem de mim.',
    ],
    sinais_do_veu: [
      'Fazes tudo o que é esperado — trabalho, casa, relações — mas há meses que não sentes nada de verdade.',
      'As pessoas dizem-te "es tão forte" é essa frase, em vez de te confortar, pesa-te como uma sentença.',
      'Tens medo de parar porque, se parares, vais sentir o tamanho daquilo que tens evitado.',
      'Ris socialmente, respondes mensagens, cumpres horarios — mas por dentro há um silêncio enorme que ninguém ve.',
      'Já tentaste descansar é não conseguiste — porque até o descanso se tornou mais uma tarefa a cumprir.',
    ],
    guiao_reflexao: [
      'Escreve sobre o momento em que percebeste que estavas presente de corpo mas ausente de alma. Onde estavas? Com quem? O que se partiu em ti nesse dia? Deixa as palavras virem sem as corrigires.',
      'Há um papel na tua vida que já morreu mas que continuas a carregar. Escreve o elogio funebre desse papel. O que ele te deu? O que te tirou? O que ficas a sentir ao largares-lo no papel?',
      'Escreve ao teu corpo como se fosse alguém que negligenciaste durante anos. Pede-lhe desculpa. Pergunta-lhe o que precisa. Depois fica em silêncio — é escreve o que ele te responde.',
    ],
    espelho_pessoal: 'Há quanto tempo estás a fingir que estás aqui?',

    // Camada profunda
    mascaras: [
      'A funcional — a que continua a operar mesmo quando já não sente nada. O corpo executa, a alma retirou-se. De fora, parece estável. Por dentro, há um deserto. O esforço deixou de ser vontade — tornou-se inercia, a máquina que não sabe parar.',
      'A disponível — a que diz "conta comigo" quando já não tem nada para dar. A disponibilidade não é generosidade — é o último fio que a liga a um sentido de existir. Sem alguém a precisar dela, não sabe para que serve o dia.',
      'A invisível — a que se apagou tão devagar que ninguém reparou. Não houve drama, não houve ruptura. Houve apenas um recuo lento, capítulo a capítulo, até restar só a sombra de quem era. O esforço dela é não incomodar — existir sem ocupar espaço.',
    ],
    veu_dominante_sinais: [
      'Já não te lembras de quando começaste a funcionar no automático. Há tanto tempo que operas sem presença que a ausência interior se tornou o teu estado normal.',
      'Quando alguém te pergunta "o que sentes?", a resposta honesta seria "não sei" — mas dizes qualquer coisa para que a conversa avance é ninguém repare no vazio.',
      'O teu corpo da sinais há meses — tensão, insónia, dores sem causa — mas tu continuas porque parar significaria enfrentar tudo o que tens empurrado para baixo do esforço.',
      'Olhas para a tua vida e, objectivamente, "está tudo bem". Mas há uma parte de ti que sabe que não estás la — que assistes a tua própria vida como espectadora.',
      'A ideia de chorar, de gritar, de sentir alguma coisa intensa, parece-te ao mesmo tempo necessária é perigosa — como se, se comecasses, não conseguisses parar.',
    ],
    mensagem_central: 'O esgotamento que sentes não é fraqueza — é a tua alma a recusar continuar a fingir. Há uma inteligência profunda nessa paragem forçada, nessa ausência que te assusta. O corpo que continua a funcionar sem ti presente está a dar-te tempo, mas também está a avisar-te: não podes viver assim para sempre. A pausa que evitas não é o fim — é a passagem. Algures no silêncio que te mete medo vive uma versão de ti que não precisa de esforço para existir. Que não precisa de ser útil para justificar o seu lugar. Essa versão não te pede que faças mais. Pede-te que deixes de fugir. Pede-te que pares — é que, ao parar, permitas que o choro venha, que o luto se faça, que os papéis que já morreram possam finalmente ser enterrados com a honra que merecem.',
    guiao_escrita: {
      contexto: 'Este exercício convida-te a encontrar o momento exacto em que te ausentaste de ti mesma — não para o julgares, mas para o reconheceres como real.',
      passos: [
        'Senta-te em silêncio. Respira três vezes devagar. Depois escreve no topo da página: "Eu parti quando..."  Deixa a frase completar-se. Pode ser um momento concreto ou uma sensação difusa. Escreve sem parar durante cinco minutos.',
        'Agora escreve uma descrição do teu dia — como se fosses uma observadora externa. Descreve os teus gestos, os teus horarios, as tuas rotinas. Escreve na terceira pessoa: "Ela acorda as sete. Ela prepara o pequeno-almoco. Ela sorri quando lhe falam."',
        'Lê o que escreveste. Há algum momento nessa descrição em que sintas que "ela" é tu? Marca-o. E há algum momento em que sintas que "ela" é uma estranha? Marca-o também.',
        'Escreve uma única frase que comece com: "O que eu preciso não é de mais esforço. O que eu preciso e..." Não penses. Escreve o que vier.',
        'Fecha os olhos. Coloca a mão no peito. Pergunta ao teu corpo: "Ainda estás aqui?" Espera. Escreve o que ele te responder — mesmo que seja silêncio.',
      ],
      tempo_sugerido: '30 a 40 minutos',
      nota_final: 'Se o exercício te trouxer emoção, não a empurres. Esse é o sinal de que estavas mesmo la — por baixo da funcionalidade, por baixo do esforço, por baixo da ausência. A emoção é o regresso.',
    },
  },
  {
    capitulo_numero: 15,
    resumo_acessivel: [
      'O autocuidado pode ser regresso genuino a si — ou nova armadilha. Os mesmos gestos que nutrem (um banho, um chá, descanso) podem aprisionar quando se tornam estética, performance ou exibição.',
      'Este capítulo explora como o prazer nascido do esgotamento se torna estrategia de sobrevivência em vez de abundância. E como a acumulação de conhecimento pode servir para evitar sentir.',
      'A espiritualidade livre não depende de rituais perfeitos, mestres externos ou certificados. Depende de presença.',
    ],
    perguntas_orientadoras: [
      'O teu autocuidado nutre-te ou é mais uma obrigação na lista?',
      'Já usaste conhecimento — livros, cursos, teorias — para evitar confrontar algo que sentias?',
      'Consegues distinguir entre o que te faz bem é o que te faz parecer bem?',
    ],
    exemplos_concretos: [
      {
        contexto: 'Na vida moderna',
        texto: 'Imagina que compras cristais, práticas yoga, bebes smoothies verdes, postas tudo nas redes. Sentes-te melhor? Ou sentes-te melhor porque pareces melhor? O capítulo chama-lhe "vitrine da alma" — quando o autocuidado se torna montra.',
      },
    ],
    notas_contextuais: [
      {
    ...
    // Jornada de autodescobertas
    crencas_a_mapear: [
      'Se não estou a trabalhar em mim mesma, estou a regredir.',
      'O autocuidado é algo que preciso de merecer — só depois de ter dado o suficiente.',
      'Quanto mais sei sobre espiritualidade, mais perto estou da verdade.',
      'Se o meu ritual não é perfeito, não conta.',
    ...
    guiao_reflexao: [
      'Faz uma lista de tudo o que fazes "por ti". Agora, ao lado de cada item, escreve com honestidade: faco isto porque me nutre ou porque me faz sentir que estou a fazer o suficiente? Não há respostas erradas — há respostas honestas.',
    ...
    guiao_escrita: {
      ...
      passos: [
        'Escreve no topo da página: "Aquilo que faco por mim." Lista todas as práticas, rituais é hábitos que consideras autocuidado. Inclui tudo: meditação, exercício, leituras, terapia, journaling, o que for.',
        'Agora, ao lado de cada item, escreve uma de três palavras: "nutricao" (faz-me genuinamente bem), "hábito" (faco porque me habituei) ou "esforço" (faco porque sinto que devia). Se honesta — ninguém vai ler isto.',
  ...
  },
  {
    ...
    notas_contextuais: [
      {
        paragrafo_indice: 5,
        texto: 'Krishnamurti insistia: "a verdade é uma terra sem caminhos". Não há método, não há sistema, não há mestre que te possa dar o que já está em ti. A verdade revela-se quando paras de a procurar.',
      },
      {
        paragrafo_indice: 12,
        texto: 'Nisargadatta Maharaj dizia: "não és o que pensas que és". A consciência que emerge do aquietar não é uma conquista — é o que resta quando todo o esforço se dissolve.',
      },
      {
        paragrafo_indice: 18,
        texto: 'Rilke escreveu: "vive as perguntas agora". O "desconhecido como passagem" não é ameaça — é a própria matéria da coragem espiritual. Não saber é o terreno mais fértil.',
      },
    ],
    ...
    espelho_pessoal: 'E se já não há nada para procurar — é tudo o que precisas já está aqui, neste exacto momento?',
    ...
    veu_dominante_sinais: [
      ...
      'Comparas-te com outros caminhos espirituais, com outras pessoas, com versões ideais de ti mesma. O esforço de "chegar la" impede-te de sentir que já estás aqui.',
