...
export const veu4Niveis: NivelCapitulo[] = [
  {
    ...
    perguntas_orientadoras: [
      ...
      'Quando foi a última vez que disseste "não" a alguém que amas — e sentiste que era um acto de amor, não de rejeição?',
    ...
    notas_contextuais: [
      {
        paragrafo_indice: 5,
        texto: 'A "âncora silenciosa" é a pessoa que sustenta os outros sem ser vista. O texto não julga esse papel — reconhece-o e pergunta: a que custo?',
      },
      {
        paragrafo_indice: 12,
        texto: 'O Taoismo ensina que yin e yang se complementam: dar e receber, força e fragilidade, acção e repouso. Quando só há dar, o equilíbrio parte-se. Dizer "não" pode ser o gesto que restaura o fluxo.',
      },
      {
        paragrafo_indice: 20,
        texto: 'O "cuidado que aprisiona" é codependência: um padrão onde quem dá precisa de ser necessário e quem recebe precisa de ser cuidado. Ambos ficam presos num gesto que já não é livre.',
      },
    ],
    ...
    crencas_a_mapear: [
      ...
      'O meu valor vem daquilo que faço pelos outros, não daquilo que sou.',
    ...
    sinais_do_veu: [
      ...
      'Quando alguém te pergunta "como estás?", respondes automaticamente "bem" — e já nem sabes se é verdade.',
      'Dizes "sim" com a boca e "não" com o corpo: tens dores, tensão, insónia, mas continuas a cuidar de todos.',
      'Sentes ressentimento por quem ajudas — e depois culpa pelo ressentimento.',
    ...
    // Camada profunda
    mascaras: [
      'A incansável — a que nunca descansa sem sentir culpa. Para ela, parar é desistir. O valor está no esforço, nunca no repouso. Mesmo quando o corpo implora trégua, ela encontra mais uma coisa para fazer, mais alguém para servir, mais um gesto para provar que está viva.',
      ...
      'A reparadora — a que está sempre a tentar consertar o que se partiu: relações, pessoas, situações. Descansa só quando tudo está "bem" — e como nada está nunca completamente bem, o descanso nunca chega. O esforço de reparar é o único lugar onde se sente útil.',
    ],
    veu_dominante_sinais: [
      'Os teus dias organizam-se em torno do que precisas de fazer pelos outros — e o tempo para ti aparece sempre no fim, quando já não sobra energia. O esforço pelos outros é automático; o repouso para ti é um luxo que nunca chega.',
    ...
    guiao_escrita: {
      contexto: 'Este exercício convida-te a olhar para os papéis que desempenhas e a sentir o peso real que carregas — não para os julgares, mas para reconheceres o esforço que te custa existir assim.',
      passos: [
        ...
        'Abre os olhos e escreve no topo da página: "Aquilo que carrego." Faz uma lista de tudo o que sustentas — tarefas, pessoas, preocupações, papéis. Não filtres. Deixa a lista crescer até sentires que está completa.',
  ...
  },
  {
    ...
    resumo_acessivel: [
      ...
      'Este capítulo acompanha o arco do esgotamento a retirada: o silêncio como trégua, a permanência sem presença, o cansaço de "não estar". O corpo cumpre obrigações, mas a alma partiu.',
    ...
    perguntas_orientadoras: [
      'Já te sentiste presente fisicamente mas ausente por dentro — como se estivesses a cumprir um guião sem alma?',
    ...
    exemplos_concretos: [
      {
        ...
        texto: 'Imagina que continuas a ir trabalhar, a cozinhar, a responder mensagens — mas há meses que não sentes nada. Não é depressão no sentido clínico. É o que o capítulo chama de "permanência sem presença": o corpo está, a alma não.',
      },
    ],
    notas_contextuais: [
      {
      ...
      {
        paragrafo_indice: 10,
        texto: 'Byung-Chul Han fala da "violência da positividade": a exigência de ser produtivo, optimista e disponível a toda a hora. O esgotamento não é fraqueza — é consequência de um sistema que não para.',
      },
      {
        paragrafo_indice: 16,
    ...
    crencas_a_mapear: [
      ...
      'A minha ausência interior é temporária — vai passar se eu continuar a funcionar.',
      'Chorar os papéis que perdi é ingratidão por tudo o que tenho.',
    ...
    guiao_reflexao: [
      ...
      'Escreve ao teu corpo como se fosse alguém que negligenciaste durante anos. Pede-lhe desculpa. Pergunta-lhe o que precisa. Depois fica em silêncio — e escreve o que ele te responde.',
    ],
    espelho_pessoal: 'Há quanto tempo estás a fingir que estás aqui?',

    // Camada profunda
    mascaras: [
      'A funcional — a que continua a operar mesmo quando já não sente nada. O corpo executa, a alma retirou-se. De fora, parece estável. Por dentro, há um deserto. O esforço deixou de ser vontade — tornou-se inércia, a máquina que não sabe parar.',
    ...
    veu_dominante_sinais: [
      ...
      'Quando alguém te pergunta "o que sentes?", a resposta honesta seria "não sei" — mas dizes qualquer coisa para que a conversa avance e ninguém repare no vazio.',
      'O teu corpo dá sinais há meses — tensão, insónia, dores sem causa — mas tu continuas porque parar significaria enfrentar tudo o que tens empurrado para baixo do esforço.',
      'Olhas para a tua vida e, objectivamente, "está tudo bem". Mas há uma parte de ti que sabe que não estás lá — que assistes a tua própria vida como espectadora.',
      'A ideia de chorar, de gritar, de sentir alguma coisa intensa, parece-te ao mesmo tempo necessária e perigosa — como se, se comecasses, não conseguisses parar.',
    ],
    mensagem_central: 'O esgotamento que sentes não é fraqueza — é a tua alma a recusar continuar a fingir. Há uma inteligência profunda nessa paragem forçada, nessa ausência que te assusta. O corpo que continua a funcionar sem ti presente está a dar-te tempo, mas também está a avisar-te: não podes viver assim para sempre. A pausa que evitas não é o fim — é a passagem. Algures no silêncio que te mete medo vive uma versão de ti que não precisa de esforço para existir. Que não precisa de ser útil para justificar o seu lugar. Essa versão não te pede que faças mais. Pede-te que deixes de fugir. Pede-te que pares — e que, ao parar, permitas que o choro venha, que o luto se faça, que os papéis que já morreram possam finalmente ser enterrados com a honra que merecem.',
    guiao_escrita: {
      ...
      passos: [
        ...
        'Agora escreve uma descrição do teu dia — como se fosses uma observadora externa. Descreve os teus gestos, os teus horários, as tuas rotinas. Escreve na terceira pessoa: "Ela acorda as sete. Ela prepara o pequeno-almoço. Ela sorri quando lhe falam."',
        ...
        'Escreve uma única frase que comece com: "O que eu preciso não é de mais esforço. O que eu preciso é..." Não penses. Escreve o que vier.',
      ...
      nota_final: 'Se o exercício te trouxer emoção, não a empurres. Esse é o sinal de que estavas mesmo lá — por baixo da funcionalidade, por baixo do esforço, por baixo da ausência. A emoção é o regresso.',
    },
  },
  {
    capitulo_numero: 15,
    resumo_acessivel: [
      'O autocuidado pode ser regresso genuíno a si — ou nova armadilha. Os mesmos gestos que nutrem (um banho, um chá, descanso) podem aprisionar quando se tornam estética, performance ou exibição.',
      'Este capítulo explora como o prazer nascido do esgotamento se torna estratégia de sobrevivência em vez de abundância. E como a acumulação de conhecimento pode servir para evitar sentir.',
    ...
    perguntas_orientadoras: [
      ...
      'Consegues distinguir entre o que te faz bem e o que te faz parecer bem?',
    ],
    exemplos_concretos: [
      {
