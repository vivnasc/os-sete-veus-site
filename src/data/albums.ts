...
const LIVRO_FILOSOFICO: Album = {
  ...
  color: "#8B5CF6",
  tracks: [
    { number: 1, title: "O Convite", description: "O inicio da travessia", lang: "PT", prompt: `${BASE_STYLE} Lyrics in Portuguese. Opening, solemn yet warm, philosophical invitation. Piano, soft strings, spacious reverb. Beginning of a deep journey inward.`, durationSeconds: 300, audioUrl: null },
    { number: 2, title: "Illusion", description: "O veu dourado", lang: "EN", prompt: `${BASE_STYLE} Lyrics in English. Golden, dreamy, questioning reality. Ethereal synth pads, soft vocal. Illusion dissolving slowly, tender awakening.`, durationSeconds: 240, audioUrl: null },
    { number: 3, title: "Medo", description: "O veu verde", lang: "PT", prompt: `${BASE_STYLE} Lyrics in Portuguese. Cautious, green-toned, careful. Muted piano, careful melody. Fear as protector, walking carefully through shadows.`, durationSeconds: 240, audioUrl: null },
    { number: 4, title: "Guilt", description: "O veu rosa", lang: "EN", prompt: `${BASE_STYLE} Lyrics in English. Weighted, rose-toned, heavy then lightening. Deep strings releasing. Guilt transforming into self-compassion.`, durationSeconds: 240, audioUrl: null },
    { number: 5, title: "Identidade", description: "O veu terra", lang: "PT", prompt: `${BASE_STYLE} Lyrics in Portuguese. Grounded, earthy, masks falling. Deep bass, organic rhythm. Identity emerging from beneath roles.`, durationSeconds: 240, audioUrl: null },
    { number: 6, title: "Control", description: "O veu azul", lang: "EN", prompt: `${BASE_STYLE} Lyrics in English. Fluid, blue-toned, releasing grip. Water textures, flowing piano. Control releasing into trust.`, durationSeconds: 240, audioUrl: null },
    { number: 7, title: "Desejo", description: "O veu violeta", lang: "PT", prompt: `${BASE_STYLE} Lyrics in Portuguese. Yearning, violet-toned, warm and searching. Deep warm tones, searching vocal melody. True desire emerging.`, durationSeconds: 240, audioUrl: null },
    { number: 8, title: "Separation", description: "O veu lavanda", lang: "EN", prompt: `${BASE_STYLE} Lyrics in English. Homecoming, lavender-toned, returning. Return melody, wholeness. Coming home to self after the journey.`, durationSeconds: 240, audioUrl: null },
    { number: 9, title: "O Espelho", description: "O olhar final", lang: "PT", prompt: `${BASE_STYLE} Lyrics in Portuguese. Reflective, complete, all themes woven together. Full arrangement, vocal crescendo. Mirror reflecting wholeness. Peaceful, triumphant resolution.`, durationSeconds: 300, audioUrl: null },
  ],
};
