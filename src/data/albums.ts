...
function espelhoPrompt(theme: string, emotion: string, production: string, lang: "PT" | "EN", energy: TrackEnergy = "whisper", flavor: TrackFlavor = "organic"): string {
  const langNote = lang === "PT" ? "Lyrics in Portuguese. Mozambican Portuguese pronunciation — softer European Portuguese, open vowels, gentle cadence, warm and unhurried. NOT strong Portugal/Lisbon accent." : "Lyrics in English.";
...
const LIVRO_FILOSOFICO: AlbumDef = {
  ...
  color: "#8B5CF6",
  tracks: [
    { number: 1, title: "O Convite", description: "O inicio da travessia interior", lang: "PT", prompt: `${BASE_STYLE} Lyrics in Portuguese. Mozambican Portuguese pronunciation — softer European Portuguese, open vowels, gentle cadence, warm and unhurried. NOT strong Portugal/Lisbon accent. Opening, solemn yet warm, philosophical invitation. Piano, soft strings, spacious reverb. Beginning of a deep journey inward. A cartography of consciousness.`, durationSeconds: 300, audioUrl: null },
    ...
    { number: 3, title: "Memoria", description: "Encobre a liberdade do presente, mantendo-nos presos as historias do passado", lang: "PT", prompt: `${BASE_STYLE} Lyrics in Portuguese. Mozambican Portuguese pronunciation — softer European Portuguese, open vowels, gentle cadence, warm and unhurried. NOT strong Portugal/Lisbon accent. Theme: memory as prison, stories of the past holding us captive. Nostalgic melody slowly loosening, freeing from old narratives. Piano with reverb-heavy textures, time stretching.`, durationSeconds: 240, audioUrl: null },
    ...
    { number: 5, title: "Esforco", description: "Encobre o repouso interior, fazendo-nos acreditar que a plenitude depende da busca incessante", lang: "PT", energy: "pulse", prompt: `${ENERGY_STYLES.pulse} Lyrics in Portuguese. Mozambican Portuguese pronunciation — softer European Portuguese, open vowels, gentle cadence, warm and unhurried. NOT strong Portugal/Lisbon accent. Theme: effort as veil, the belief that fullness requires endless striving. Busy, driven rhythm slowly releasing into rest. The beauty of stopping.`, durationSeconds: 240, audioUrl: null },
    ...
    { number: 9, title: "O Espelho", description: "O olhar final — tudo o que atravessaste ja la estava", lang: "PT", energy: "anthem", prompt: `${ENERGY_STYLES.anthem} Lyrics in Portuguese. Mozambican Portuguese pronunciation — softer European Portuguese, open vowels, gentle cadence, warm and unhurried. NOT strong Portugal/Lisbon accent. Closing. All seven themes woven together. Full arrangement, vocal crescendo. The mirror reflects wholeness that was always there. Peaceful, triumphant, complete resolution.`, durationSeconds: 300, audioUrl: null },
  ],
};
