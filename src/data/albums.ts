...
// Sabor musical — o genero/registo da faixa (segunda dimensao alem da energia)
// organic: contemporaneo organico-electronico (o default, o som "Aruna Serena" base)
// afro: ritmos africanos, marrabenta, djembe, mbira, kora, percussao organica mocambicana
// house: house/dance, four-on-the-floor, deep bass, club energy, batida para correr
// gospel: gospel/espiritual, coral, uplifting, exaltacao, community singing
export type TrackFlavor = "organic" | "afro" | "house" | "gospel";
...
// Modificadores de sabor musical — aplicados sobre o estilo de energia
const FLAVOR_MODIFIERS: Record<TrackFlavor, string> = {
  organic: "", // default, nenhum modificador
  afro: "Afrobeats-influenced, marrabenta rhythms, djembe and shaker percussion, mbira textures, kora-like melodies, Mozambican groove, warm polyrhythmic layers, African call-and-response energy.",
  house: "House music influence, four-on-the-floor kick, deep bass, hi-hat groove, synth stabs, club warmth, dance-floor energy, infectious rhythmic drive, great for running.",
...
const ESPELHO_ILUSAO: AlbumDef = {
  ...
  tracks: [
    ...
    { number: 5, title: "The Body Knows", description: "O corpo ja sabia antes da mente", lang: "EN", energy: "steady", flavor: "afro", prompt: espelhoPrompt("body wisdom, somatic truth, the body knew first", "grounding, warm, pulsing with life", "heartbeat rhythm, warm bass, organic percussion, breath sounds woven in", "EN", "steady", "afro"), durationSeconds: 240, audioUrl: null },
...
const ESPELHO_MEDO: AlbumDef = {
  ...
  tracks: [
    ...
    { number: 4, title: "O Estomago Sabe", description: "Quando o corpo fala primeiro", lang: "PT", energy: "pulse", flavor: "afro", prompt: espelhoPrompt("gut feeling, body alarm, visceral knowledge", "visceral, urgent, body-driven", "low bass pulse, driving organic percussion, rising intensity, body-felt", "PT", "pulse", "afro"), durationSeconds: 240, audioUrl: null },
...
const ESPELHO_CULPA: AlbumDef = {
  ...
  tracks: [
    ...
    { number: 3, title: "Alivio ou Alegria", description: "A diferenca entre querer e dever", lang: "PT", energy: "pulse", flavor: "house", prompt: espelhoPrompt("relief vs joy, duty vs desire, learning the difference", "contrasting, energetic questioning", "two melodic lines competing, driving piano, rhythmic vocal, building momentum", "PT", "pulse", "house"), durationSeconds: 240, audioUrl: null },
    ...
    { number: 5, title: "Deserve", description: "Merecer nao se conquista", lang: "EN", energy: "anthem", flavor: "gospel", prompt: espelhoPrompt("deserving is not earned, inherent worth, you already deserve", "warm, affirming, powerful, like a declaration", "warm strings, building drums, layered vocals, empowering chorus", "EN", "anthem", "gospel"), durationSeconds: 240, audioUrl: null },
...
const ESPELHO_IDENTIDADE: AlbumDef = {
  ...
  tracks: [
    ...
    { number: 3, title: "Armadura", description: "A certeza que parece forca", lang: "PT", energy: "pulse", flavor: "afro", prompt: espelhoPrompt("armor, certainty that looks like strength, false protection", "rigid, building energy, breaking through", "crystalline synth, driving percussion, tension building to release", "PT", "pulse", "afro"), durationSeconds: 240, audioUrl: null },
...
const ESPELHO_CONTROLO: AlbumDef = {
  ...
  tracks: [
    ...
    { number: 6, title: "Largar", description: "O mundo continua quando nao fazes", lang: "PT", energy: "anthem", flavor: "afro", prompt: espelhoPrompt("letting go, the world continues when you stop doing", "relief, triumphant, lightness, liberation", "full arrangement, bright textures, driving chorus, free vocal melody", "PT", "anthem", "afro"), durationSeconds: 240, audioUrl: null },
...
const ESPELHO_DESEJO: AlbumDef = {
  ...
  tracks: [
    ...
    { number: 6, title: "Desejo Verdadeiro", description: "O que a tua vida esta a pedir", lang: "PT", energy: "anthem", flavor: "afro", prompt: espelhoPrompt("true desire, what your life is asking of you", "warm, powerful, knowing, declarative", "rich warm synth, driving drums, layered vocals, empowering build", "PT", "anthem", "afro"), durationSeconds: 240, audioUrl: null },
...
const ESPELHO_SEPARACAO: AlbumDef = {
  ...
  tracks: [
    ...
    { number: 4, title: "Separar", description: "Criar espaco, nao destruir", lang: "PT", energy: "pulse", flavor: "afro", prompt: espelhoPrompt("separating to create space, not to destroy", "bittersweet, determined, forward momentum", "driving rhythm, melody splitting into two lines, both beautiful, energy", "PT", "pulse", "afro"), durationSeconds: 240, audioUrl: null },
...
const NO_SILENCIO = noAlbum(2, "no-silencio", "O No do Silencio", "O que o medo calou entre eles", [
  ...
  { number: 4, title: "Ouvir de Verdade", description: "Quando ouvir e mais que escutar", lang: "PT", energy: "pulse", flavor: "house", prompt: noPrompt("truly hearing, listening deeper than words", "open, energetic, present, understanding building", "call and response vocal, driving rhythm, deepening harmony", "PT", "pulse", "house"), durationSeconds: 240 },
  { number: 5, title: "Voice", description: "Encontrar a voz que calaste", lang: "EN", energy: "anthem", flavor: "afro", prompt: noPrompt("finding the voice you silenced, speaking truth at last", "empowered, declarative, liberated, triumphant", "two voices in powerful harmony, driving drums, liberation", "EN", "anthem", "afro"), durationSeconds: 300 },
]);
...
const NO_SACRIFICIO = noAlbum(3, "no-sacrificio", "O No do Sacrificio", "A culpa disfarcada de entrega", [
  ...
  { number: 2, title: "Love or Debt", description: "Quando amar parece pagar", lang: "EN", energy: "pulse", flavor: "house", prompt: noPrompt("love as debt, paying off guilt through giving", "transactional, driving, urgent realization", "counting rhythmic pattern, driving beat, weighted bass", "EN", "pulse", "house"), durationSeconds: 240 },
  ...
  { number: 5, title: "True Giving", description: "Dar sem se perder", lang: "EN", energy: "anthem", flavor: "gospel", prompt: noPrompt("true giving without losing yourself, generous freedom", "generous, powerful, loving, declarative", "generous flowing melody, layered vocals, triumphant chorus", "EN", "anthem", "gospel"), durationSeconds: 300 },
]);
...
const NO_VERGONHA = noAlbum(4, "no-vergonha", "O No da Vergonha", "A mascara que caiu entre dois estranhos", [
  ...
  { number: 3, title: "Sem Papeis", description: "Quando os papeis caem entre dois", lang: "PT", energy: "pulse", flavor: "afro", prompt: noPrompt("roles falling away between two people, authenticity emerging", "liberating, energetic, brave, momentum", "driving rhythm, layers dropping away, simplifying to truth", "PT", "pulse", "afro"), durationSeconds: 240 },
  ...
  { number: 5, title: "Unapologetic", description: "Existir sem pedir desculpa", lang: "EN", energy: "anthem", flavor: "house", prompt: noPrompt("existing without apology, unapologetic being", "free, proud, powerful, sovereign", "proud melody, driving drums, layered vocal strength, triumphant", "EN", "anthem", "house"), durationSeconds: 300 },
]);
...
const NO_SOLIDAO = noAlbum(5, "no-solidao", "O No da Solidao", "O controlo que isolou quem mais amava", [
  ...
  { number: 5, title: "Bridge", description: "A solidao que se transforma em ponte", lang: "EN", energy: "anthem", flavor: "afro", prompt: noPrompt("solitude becoming a bridge, loneliness transformed to connection", "connecting, triumphant, hopeful, powerful", "bridge melody connecting voices, driving drums, triumphant hope", "EN", "anthem", "afro"), durationSeconds: 300 },
]);
...
const NO_VAZIO = noAlbum(6, "no-vazio", "O No do Vazio", "O desejo que esvaziou a amizade", [
  ...
  { number: 4, title: "Reencontro", description: "Reencontrar sem exigir", lang: "PT", energy: "pulse", flavor: "afro", prompt: noPrompt("reunion without demands, meeting again freely", "reconnecting, energetic, joyful, wiser", "two driving melodies reconnecting, rhythmic joy, maturity", "PT", "pulse", "afro"), durationSeconds: 240 },
  { number: 5, title: "True Friendship", description: "O espaco onde o desejo verdadeiro mora", lang: "EN", energy: "anthem", flavor: "gospel", prompt: noPrompt("true friendship, the space where authentic desire lives", "genuine, powerful, complete, celebratory", "warm duet, layered vocals, driving chorus, triumphant peace", "EN", "anthem", "gospel"), durationSeconds: 300 },
]);
...
const NO_PERTENCA = noAlbum(7, "no-pertenca", "O No da Pertenca", "A separacao que reinventou o lar", [
  ...
  { number: 5, title: "Belonging", description: "Pertencer comeca por dentro", lang: "EN", energy: "anthem", flavor: "afro", prompt: noPrompt("belonging starts within, self-belonging is home", "whole, powerful, complete, triumphant peace", "coming home melody, layered vocals, driving drums, triumphant resolution", "EN", "anthem", "afro"), durationSeconds: 300 },
]);
...
const LIVRO_FILOSOFICO: AlbumDef = {
  ...
  tracks: [
    ...
    { number: 3, title: "Memoria", description: "Encobre a liberdade do presente, mantendo-nos presos as historias do passado", lang: "PT", flavor: "afro", prompt: `${BASE_STYLE} Lyrics in Portuguese. Theme: memory as prison, stories of the past holding us captive. Nostalgic melody slowly loosening, freeing from old narratives. Piano with reverb-heavy textures, time stretching. ${FLAVOR_MODIFIERS.afro}`, durationSeconds: 240, audioUrl: null },
    ...
    { number: 5, title: "Esforco", description: "Encobre o repouso interior, fazendo-nos acreditar que a plenitude depende da busca incessante", lang: "PT", energy: "pulse", flavor: "house", prompt: `${ENERGY_STYLES.pulse} Lyrics in Portuguese. Theme: effort as veil, the belief that fullness requires endless striving. Busy, driven rhythm slowly releasing into rest. The beauty of stopping. ${FLAVOR_MODIFIERS.house}`, durationSeconds: 240, audioUrl: null },
    ...
    { number: 9, title: "O Espelho", description: "O olhar final — tudo o que atravessaste ja la estava", lang: "PT", energy: "anthem", flavor: "gospel", prompt: `${ENERGY_STYLES.anthem} Lyrics in Portuguese. Closing. All seven themes woven together. Full arrangement, vocal crescendo. The mirror reflects wholeness that was always there. Peaceful, triumphant, complete resolution. ${FLAVOR_MODIFIERS.gospel}`, durationSeconds: 300, audioUrl: null },
  ],
};
...
const CURSO_OURO_PROPRIO = cursoAlbum("curso-ouro-proprio", "ouro-proprio", "Ouro Proprio", "A tua relacao com dinheiro", "Casa dos Espelhos Dourados", [
  ...
  { number: 3, title: "Heranca Financeira", description: "O dinheiro da tua familia", lang: "PT", energy: "steady", flavor: "afro", prompt: cursoPrompt("family money story, inherited beliefs about wealth", "ancestral, complex, untangling patterns", "deep pad, ancestral vocal texture, untangling melodic lines", "PT", "steady", "afro"), durationSeconds: 240 },
  ...
  { number: 5, title: "Novo Espelho", description: "O reflexo que escolhes", lang: "PT", energy: "anthem", flavor: "gospel", prompt: cursoPrompt("new mirror, the reflection you choose", "clear, chosen, golden peace, resolution", "clear golden tones, chosen vocal melody, peaceful resolution", "PT", "anthem", "gospel"), durationSeconds: 300 },
]);
...
const CURSO_SANGUE_SEDA = cursoAlbum("curso-sangue-seda", "sangue-e-seda", "Sangue e Seda", "A tua mae, a tua historia", "Arvore das Raizes Visiveis", [
  ...
  { number: 3, title: "Sangue", description: "O que herdaste no sangue", lang: "PT", energy: "pulse", flavor: "afro", prompt: cursoPrompt("blood inheritance, what runs deep in your veins", "visceral, pulsing, deep connection", "heartbeat rhythm, deep organic percussion, blood-pulse bass", "PT", "pulse", "afro"), durationSeconds: 240 },
  ...
  { number: 5, title: "Amanhecer", description: "A arvore com raizes reorganizadas", lang: "PT", energy: "anthem", flavor: "afro", prompt: cursoPrompt("dawn, reorganized roots, new growth from old ground", "dawn, growing, reorganized, fresh start", "dawn-like rising melody, new growth textures, reorganized beauty", "PT", "anthem", "afro"), durationSeconds: 300 },
]);
...
const CURSO_ARTE_INTEIREZA = cursoAlbum("curso-arte-inteireza", "a-arte-da-inteireza", "A Arte da Inteireza", "Amar sem te perderes", "Ponte entre Duas Margens", [
  ...
  { number: 4, title: "The Bridge", description: "Encontrar sem se perder", lang: "EN", energy: "anthem", flavor: "gospel", prompt: cursoPrompt("the bridge, meeting without losing yourself", "connected, balanced, harmonious, mature love", "balanced duet over bridge of sound, meeting in wholeness", "EN", "anthem", "gospel"), durationSeconds: 300 },
]);
...
const CURSO_DEPOIS_FOGO = cursoAlbum("curso-depois-fogo", "depois-do-fogo", "Depois do Fogo", "Recomecar apos a destruicao", "Campo Queimado", [
  ...
  { number: 4, title: "Different", description: "O novo nao e o antigo — e outra coisa", lang: "EN", energy: "pulse", flavor: "afro", prompt: cursoPrompt("the new is not the old, it is something else entirely", "transformed, different, evolved, acceptance of change", "transformed melody, new form, evolved beauty, resolution", "EN", "pulse", "afro"), durationSeconds: 300 },
]);
...
const CURSO_OLHOS_ABERTOS = cursoAlbum("curso-olhos-abertos", "olhos-abertos", "Olhos Abertos", "Decidir com clareza", "Encruzilhada Infinita", [
  ...
  { number: 4, title: "First Step", description: "A silhueta da o primeiro passo", lang: "EN", energy: "pulse", flavor: "house", prompt: cursoPrompt("the first step, choosing a direction, walking forward", "decisive, brave, clear, momentum", "decisive rhythm beginning, first clear step, direction found", "EN", "pulse", "house"), durationSeconds: 300 },
]);
...
const CURSO_PELE_NUA = cursoAlbum("curso-pele-nua", "pele-nua", "Pele Nua", "O corpo como territorio", "Corpo-Paisagem", [
  ...
  { number: 3, title: "Habitar", description: "Voltar a viver no corpo", lang: "PT", energy: "steady", flavor: "afro", prompt: cursoPrompt("inhabiting, returning to live in the body again", "embodied, present, grounded, arrived", "grounded rhythm, inhabited vocal, fully present production", "PT", "steady", "afro"), durationSeconds: 240 },
...
const CURSO_LIMITE_SAGRADO = cursoAlbum("curso-limite-sagrado", "limite-sagrado", "Limite Sagrado", "Dizer nao sem culpa", "Muralha que Nasce do Chao", [
  ...
  { number: 4, title: "Sacred", description: "O limite como acto de amor", lang: "EN", energy: "anthem", flavor: "gospel", prompt: cursoPrompt("sacred boundary, limit as an act of love", "sacred, loving, complete, holy protection", "sacred vocal melody, loving boundary in production, golden peace", "EN", "anthem", "gospel"), durationSeconds: 300 },
]);
...
const CURSO_PESO_CHAO = cursoAlbum("curso-peso-chao", "o-peso-e-o-chao", "O Peso e o Chao", "Largar o que carregas", "Caminho de Pedras", [
  ...
  { number: 4, title: "Standing", description: "Erguida, leve, as pedras no chao", lang: "EN", energy: "anthem", flavor: "house", prompt: cursoPrompt("standing tall, light, stones on the ground, unburdened", "light, upright, free, weightless joy", "light free melody, standing tall vocal, liberated movement in rhythm", "EN", "anthem", "house"), durationSeconds: 300 },
]);
...
const CURSO_VOZ_DENTRO = cursoAlbum("curso-voz-dentro", "voz-de-dentro", "Voz de Dentro", "Encontrar a tua voz", "Sala do Eco", [
  ...
  { number: 4, title: "Sing", description: "A voz que canta por fim", lang: "EN", energy: "anthem", flavor: "afro", prompt: cursoPrompt("singing at last, voice freed, the full expression", "singing, free, joyful, complete, triumphant", "full voice singing free, joyful vocal resolution, complete expression", "EN", "anthem", "afro"), durationSeconds: 300 },
]);
...
const CURSO_CHAMA = cursoAlbum("curso-chama", "a-chama", "A Chama", "A raiva como forca", "Vulcao Adormecido", [
  ...
  { number: 3, title: "Fogo Controlado", description: "A raiva como aliada", lang: "PT", energy: "pulse", flavor: "afro", prompt: cursoPrompt("controlled fire as ally, rage channeled not destroyed", "fierce, controlled, powerful, warm light", "fierce controlled rhythm, powerful channeled vocal, warm fierce light", "PT", "pulse", "afro"), durationSeconds: 240 },
  { number: 4, title: "Blaze", description: "O vulcao que ilumina", lang: "EN", energy: "anthem", flavor: "house", prompt: cursoPrompt("active beautiful volcano illuminating landscape, power embraced", "blazing, beautiful, powerful, red-gold", "blazing powerful production, beautiful fierce vocal, red-gold triumph", "EN", "anthem", "house"), durationSeconds: 300 },
]);
...
const CURSO_MULHER_MAE = cursoAlbum("curso-mulher-mae", "a-mulher-antes-de-mae", "A Mulher Antes de Mae", "Quem eras antes do ninho", "Ninho que Pesa", [
  ...
  { number: 4, title: "Whole Nest", description: "O ninho com espaco", lang: "EN", energy: "anthem", flavor: "afro", prompt: cursoPrompt("beautiful nest with space for the whole woman, mother and self", "whole, balanced, golden ochre, complete", "whole balanced melody, golden ochre production, complete woman vocal", "EN", "anthem", "afro"), durationSeconds: 300 },
]);
...
const CURSO_COROA = cursoAlbum("curso-coroa", "a-coroa-escondida", "A Coroa Escondida", "O poder que e teu", "Trono Coberto", [
  ...
  { number: 4, title: "Crown", description: "Sentada no trono, sem permissao", lang: "EN", energy: "anthem", flavor: "gospel", prompt: cursoPrompt("seated on throne, crown on head, without permission, total presence and power", "powerful, crowned, golden-purple, sovereign", "powerful sovereign melody, crowned triumphant vocal, golden-purple majesty", "EN", "anthem", "gospel"), durationSeconds: 300 },
]);
...
const CURSO_FOME = cursoAlbum("curso-fome", "a-fome", "A Fome", "O corpo e a fome", "Mesa Vazia", [
  ...
  { number: 4, title: "Feast", description: "Em paz com o prato e com o corpo", lang: "EN", energy: "steady", flavor: "afro", prompt: cursoPrompt("at peace with the plate, inhabited body, presence, terracotta and porcelain", "peaceful, inhabited, terracotta warmth, complete", "peaceful inhabited melody, complete warm vocal, terracotta porcelain beauty", "EN", "steady", "afro"), durationSeconds: 300 },
]);
...
export const FLAVOR_LABELS: Record<TrackFlavor, { label: string; emoji: string; color: string }> = {
  ...
  afro: { label: "Afro", emoji: "a", color: "bg-amber-50 text-amber-700" },
