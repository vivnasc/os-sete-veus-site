...
export type TrackFlavor = "organic" | "afrobeat" | "bossa" | "jazz" | "folk" | "house" | "gospel";
...
const ESPELHO_ILUSAO: AlbumDef = {
  ...
  tracks: [
    ...
    { number: 5, title: "The Body Knows", description: "O corpo já sabia antes da mente", lang: "EN", energy: "steady", flavor: "afrobeat", prompt: espelhoPrompt("body wisdom, somatic truth, the body knew first", "grounding, warm, pulsing with life", "heartbeat rhythm, warm bass, organic percussion, breath sounds woven in", "EN", "steady"), durationSeconds: 240, audioUrl: null },
...
const ESPELHO_MEDO: AlbumDef = {
  ...
  tracks: [
    ...
    { number: 4, title: "O Estômago Sabe", description: "Quando o corpo fala primeiro", lang: "PT", energy: "pulse", flavor: "afrobeat", prompt: espelhoPrompt("gut feeling, body alarm, visceral knowledge", "visceral, urgent, body-driven", "low bass pulse, driving organic percussion, rising intensity, body-felt", "PT", "pulse"), durationSeconds: 240, audioUrl: null },
...
const NO_HERANCA = noAlbum(1, "no-heranca", "O Nó da Herança", "O silêncio herdado entre mãe e filha", [
  ...
  { number: 3, title: "Duas Mulheres", description: "Mae e filha, frente a frente", lang: "PT", energy: "raw", flavor: "folk", prompt: noPrompt("two women face to face, mother and daughter, raw meeting", "raw, vulnerable, brave, painfully honest", "two vocal textures meeting, tentative harmony, stripped production", "PT", "raw"), durationSeconds: 240 },
...
const CURSO_OURO_PROPRIO = cursoAlbum("curso-ouro-proprio", "ouro-proprio", "Ouro Próprio", "A tua relação com dinheiro", "Casa dos Espelhos Dourados", [
  ...
  { number: 3, title: "Herança Financeira", description: "O dinheiro da tua familia", lang: "PT", energy: "steady", flavor: "jazz", prompt: cursoPrompt("family money story, inherited beliefs about wealth", "ancestral, complex, untangling patterns", "deep pad, ancestral vocal texture, untangling melodic lines", "PT", "steady"), durationSeconds: 240 },
...
const CURSO_SANGUE_SEDA = cursoAlbum("curso-sangue-seda", "sangue-e-seda", "Sangue e Seda", "A tua mãe, a tua história", "Árvore das Raízes Visíveis", [
  { number: 1, title: "Raizes", description: "O que veio antes de ti", lang: "PT", energy: "steady", flavor: "folk", prompt: cursoPrompt("roots, what came before you, ancestral ground", "deep red, ancient, grounding", "deep bass, rich strings, root-like grounding sounds", "PT", "steady"), durationSeconds: 240 },
  ...
  { number: 3, title: "Sangue", description: "O que herdaste no sangue", lang: "PT", energy: "pulse", flavor: "afrobeat", prompt: cursoPrompt("blood inheritance, what runs deep in your veins", "visceral, pulsing, deep connection", "heartbeat rhythm, deep organic percussion, blood-pulse bass", "PT", "pulse"), durationSeconds: 240 },
...
const CURSO_PELE_NUA = cursoAlbum("curso-pele-nua", "pele-nua", "Pele Nua", "O corpo como território", "Corpo-Paisagem", [
  ...
  { number: 3, title: "Habitar", description: "Voltar a viver no corpo", lang: "PT", energy: "steady", flavor: "bossa", prompt: cursoPrompt("inhabiting, returning to live in the body again", "embodied, present, grounded, arrived", "grounded rhythm, inhabited vocal, fully present production", "PT", "steady"), durationSeconds: 240 },
...
const TRAVESSIA: AlbumDef = { slug: "travessia", title: "Travessia", subtitle: "Do amanhecer ao escuro — o dia inteiro da alma", product: "espiritual", color: "#c9a96e", tracks: [
  ...
  { number: 3, title: "Terra", description: "Pés na lama — o sagrado é raiz", lang: "PT", energy: "steady", flavor: "afrobeat", prompt: spiritualPrompt("feet in mud, sacred is dirt and root", "earthy, grounded, primal, joyful connection to soil", "warm acoustic guitar groove, earth percussion, warm grounded vocal", "PT", "steady"), durationSeconds: 240, audioUrl: null },
...
const FOLEGO: AlbumDef = { slug: "folego", title: "Fôlego", subtitle: "Entre o inspirar e o expirar — tudo o que cabe num sopro", product: "espiritual", color: "#7a9b8e", tracks: [
  ...
  { number: 7, title: "Dança", description: "O corpo em movimento como oração — pés na terra, quadris que rezam", lang: "PT", energy: "pulse", flavor: "afrobeat", prompt: spiritualPrompt("dance as prayer, body moving without thinking, feet on earth, hips remembering", "ecstatic, grounded, rhythmic prayer, body-led worship", "acoustic guitar driving, body percussion, ecstatic vocal, dance-prayer rhythm", "PT", "pulse"), durationSeconds: 260, audioUrl: null },
...
const CORPO_CELESTE: AlbumDef = { slug: "corpo-celeste", title: "Corpo Celeste", subtitle: "A pele feita de estrelas — o universo que respira em ti", product: "espiritual", color: "#8aaaca", tracks: [
  ...
  { number: 4, title: "Hymn of Skin", description: "The skin remembers every touch — a living hymn", lang: "EN", energy: "pulse", flavor: "afrobeat", prompt: spiritualPrompt("skin as hymnal, touch as prayer, the body's memory of every hand", "tactile, remembering, alive, sacred surface", "acoustic guitar pulse, shaker rhythm, skin percussion, dancing hymn", "EN", "pulse"), durationSeconds: 240, audioUrl: null },
...
const O_GESTO: AlbumDef = { slug: "o-gesto", title: "O Gesto", subtitle: "O sagrado que vive no quotidiano — no osso, no grão, no gesto", product: "espiritual", color: "#c08aaa", tracks: [
  ...
  { number: 5, title: "Servir", description: "Servir sem custar a alma — alegria no dar", lang: "PT", energy: "steady", flavor: "afrobeat", prompt: spiritualPrompt("service that doesn't cost your soul, joy in giving", "joyful, generous, rhythmic, service as dance", "joyful organic rhythm, generous vocal, dancing service, warm bass", "PT", "steady"), durationSeconds: 240, audioUrl: null },
...
const VIDA_SANGUE_ACESO = vidaAlbum("vida-sangue-aceso", "Sangue Aceso", "treino, corpo em fogo", "#E04A2F", [
  ...
  { number: 3, title: "Suor Sagrado", description: "O suor lava o que as palavras não conseguem.", lang: "PT", energy: "pulse", flavor: "afrobeat", prompt: vidaPrompt("sweat dripping from the jaw, shirt soaked, muscles burning with holy fire, the body purifying itself through effort", "sacred exertion, the cleansing power of hard physical work, almost ritualistic", "warm acoustic guitar patterns driving the rhythm, timbila-style wooden percussion, heavy bass groove, call-and-response vocal shouts, shakers and rattles building intensity, polyrhythmic layers stacking", "PT", "pulse"), durationSeconds: 240 },
  ...
  { number: 7, title: "Descarga", description: "A explosão de quem deu tudo e soltou.", lang: "PT", energy: "anthem", flavor: "afrobeat", prompt: vidaPrompt("the explosive release after maximum effort, arms thrown wide, scream of victory, the body emptied and electric, every cell vibrating", "volcanic release, pure cathartic joy, the roar after the finish line, triumphant and primal", "warm acoustic guitar erupting into full celebration, massive drum break with timbila and djembe, brass section blaring triumphant melodies, call-and-response chanting building to euphoric peak, bass shaking the floor", "PT", "anthem"), durationSeconds: 240 },
...
const VIDA_PAO_SAL = vidaAlbum("vida-pao-sal", "O Pão e o Sal", "casa, cozinha, presença doméstica", "#C9B896", [
  ...
  { number: 3, title: "Tempero", description: "O pequeno gesto que muda tudo.", lang: "PT", energy: "steady", flavor: "bossa", prompt: vidaPrompt("a pinch of salt between thumb and forefinger, the twist of the pepper mill, a squeeze of lemon that transforms everything", "playful precision, the joy of the small thing that changes everything, the cook's quiet confidence", "bright warm acoustic guitar with a playful melodic line, light timbila percussion dancing, hand claps syncopated and alive, acoustic bass grooving with warmth", "PT", "steady"), durationSeconds: 240 },
...
const VIDA_DESCALCA = vidaAlbum("vida-descalca", "Descalça", "celebrar, dançar, alegria sem razão", "#D4A853", [
  ...
  { number: 5, title: "O Corpo Sabe", description: "O corpo sabe celebrar antes da mente concordar.", lang: "PT", energy: "pulse", flavor: "afrobeat", prompt: vidaPrompt("Hips swaying before the thought forms, feet tapping before the ear fully hears. The body's ancient knowledge of celebration — how to stomp, how to let the spine become a wave", "Instinctive physical intelligence, the body leading and the mind gratefully following. Rhythm over reason", "warm organic groove that makes stillness impossible, interlocking guitar patterns with bass and percussion. Body percussion — chest slaps, thigh hits, foot stamps", "PT", "pulse"), durationSeconds: 240 },
