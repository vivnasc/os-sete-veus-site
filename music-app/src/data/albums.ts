...
const VIDA_COMPANHIA_PROPRIA = vidaAlbum("vida-companhia-propria", "Companhia Própria", "solidão escolhida, estar só sem estar perdida", "#7A7A8B", [
  ...
  { number: 5, title: "Jantar Sozinha", description: "Vela acesa, prato feito com cuidado, toda presente.", lang: "PT", energy: "steady", flavor: "marrabenta", prompt: vidaPrompt("Lighting a candle for a meal cooked just for yourself — the flame reflected in the wine glass, eating slowly, no screen, no distraction", "Celebratory solitude — the warmth of self-honouring, the revolutionary act of treating yourself as a guest worth cooking for", "Marrabenta rhythm — timbila and guitar interweaving, festive but intimate. Shakers and light hand drums. Bass guitar groovy. Vocal playful and close", "PT", "steady", "marrabenta"), durationSeconds: 240 },
...
const VIDA_RESCALDO = vidaAlbum("vida-rescaldo", "Rescaldo", "pós-conflito, depois da tempestade", "#8B7A6A", [
  ...
  { number: 4, title: "Rebuild", description: "Stone by stone, the bridge comes back — different from before.", lang: "EN", energy: "steady", prompt: vidaPrompt("Hands lifting stone — two people on opposite sides of a river, each laying stones from their end, the bridge meeting in the middle", "Determined tenderness — the stubborn hope of repair, the choice to rebuild when walking away would be easier", "Building layers — starts with a single hand drum, adds bass, adds guitar, adds keys, adds strings. Vocal duet that starts separate and harmonises by the end", "EN", "steady"), durationSeconds: 240 },
  ...
  { number: 6, title: "New Bridge", description: "A new bridge, not the old one rebuilt — something that was never here before.", lang: "EN", energy: "steady", prompt: vidaPrompt("Walking across something new — the wood still pale, the railing still smooth. Two people standing in the middle, knowing this was chosen, not inherited", "Hopeful solidity — the quiet confidence of something built with intention after something collapsed by neglect", "Full band — acoustic guitar, bass, drums, piano, strings — warm and complete. Melody that resolves upward. Trumpet playing the last note — golden, open. The ending holds, doesn't fade", "EN", "steady"), durationSeconds: 300 },
]);
...
const VIDA_OFERENDA = vidaAlbum("vida-oferenda", "Oferenda", "gratidão, o sagrado sem igreja", "#B8960B", [
  ...
  { number: 5, title: "O Que Tenho", description: "O que tenho agora, neste instante, já é tanto.", lang: "PT", energy: "steady", flavor: "marrabenta", prompt: vidaPrompt("Looking around the room and seeing it as if for the first time — the chair, the window, the light, the hands in your lap. The inventory of the present", "Joyful recognition — the celebration of what is, not what could be, the party of the present. African warmth of gratitude that dances", "Full marrabenta — timbila leading, electric guitar in the Mozambican style. Bass driving. Shakers, djembe, congas. Vocal joyful and rhythmic. Brass adding celebration", "PT", "steady", "marrabenta"), durationSeconds: 240 },
...
const VIDA_LINHAGEM = vidaAlbum("vida-linhagem", "Linhagem", "herança, sangue, o que vive em ti antes de ti", "#7A4A3A", [
  { number: 1, title: "A Avó", description: "A avó que vive nas tuas mãos, os gestos dela nos teus.", lang: "PT", energy: "steady", flavor: "marrabenta", prompt: vidaPrompt("Hands kneading dough the way hers did, wrists turning at the same angle. Fingers that reach for herbs with a grip you never learned — it was already there", "Deep ancestral warmth, the ache of recognition when your body does something you never chose. Tenderness layered with time", "Marrabenta guitar with a grandmother's patience, unhurried circular picking. Timbila-like wooden percussion, warm upright bass, a single mbira threading through like memory", "PT", "steady", "marrabenta"), durationSeconds: 240 },
  { number: 2, title: "Blood Memory", description: "What the blood remembers that the mind forgot.", lang: "EN", energy: "raw", prompt: vidaPrompt("A pulse in the wrist that carries information older than language. The body flinching at a smell it has never encountered in this lifetime", "Primal and unsettling, the vertigo of feeling something you cannot explain. Raw recognition — the body as an archive", "Deep sub-bass rumble like underground rivers, distorted cello bowing against the grain. Tribal hand drums close and dry, breath sounds woven in, no polish", "EN", "raw"), durationSeconds: 240 },
  ...
  { number: 5, title: "O Que Trouxeste", description: "O que carregaste contigo, por escolha ou não.", lang: "PT", energy: "pulse", flavor: "marrabenta", prompt: vidaPrompt("Shoulders that carry bundles wrapped in cloth, feet that know a road they've never walked. The habits that arrived with you — counting money, locking doors twice", "Determined forward motion carrying heavy things, the refusal to put them down because they are yours. Pride mixed with exhaustion", "Marrabenta rhythm driving forward, bass guitar locked in with shaker and djembe. Call-and-response vocals, electric guitar with bright Mozambican tone, building energy", "PT", "pulse", "marrabenta"), durationSeconds: 240 },
...
const VIDA_MARE_VIVA = vidaAlbum("vida-mare-viva", "Maré Viva", "ciclos, encher e esvaziar, impermanência", "#3A6B7A", [
  ...
  { number: 7, title: "Volta", description: "Tudo volta, nada se perde de verdade.", lang: "PT", energy: "steady", flavor: "marrabenta", prompt: vidaPrompt("Water returning to fill the same footprints, the same coves. The daughter becoming the mother becoming the grandmother — the same song in a new mouth", "Triumphant return, the deep relief of cycles completing. Joyful certainty — lived proof that what leaves comes back changed and whole", "Marrabenta guitar riff that circles back to its opening phrase, bass and percussion in a revolving groove. Choral voices joining one by one, timbila driving home", "PT", "steady", "marrabenta"), durationSeconds: 300 },
]);

const VIDA_DESCALCA = vidaAlbum("vida-descalca", "Descalça", "celebrar, dançar, alegria sem razão", "#D4A853", [
  { number: 1, title: "Tira os Sapatos", description: "Tira os sapatos, o chão é teu.", lang: "PT", energy: "pulse", flavor: "marrabenta", prompt: vidaPrompt("Kicking shoes off at the door, toes spreading on cool tile, the liberation of bare soles. Feet finding the ground — heel, arch, ball, toes", "Playful defiance, the giddy freedom of removing what was never comfortable. Mischievous joy", "Marrabenta guitar bouncing with infectious energy, shaker and djembe, bass guitar walking with swagger, call-and-response vocals laughing, handclaps on the offbeat", "PT", "pulse", "marrabenta"), durationSeconds: 240 },
  ...
  { number: 3, title: "Sem Razão", description: "Celebrar sem razão nenhuma.", lang: "PT", energy: "anthem", flavor: "marrabenta", prompt: vidaPrompt("Arms thrown open on an ordinary Tuesday, laughing at the ceiling for no reason. The body erupting because the sun came through the window", "Unreasonable explosive happiness, the kind that embarrasses sensible people. Wild gratitude for nothing in particular", "Full marrabenta at festival energy, horns punching, guitar riffing with abandon, massed vocals, timbila and drums pushing the tempo, pure celebration", "PT", "anthem", "marrabenta"), durationSeconds: 240 },
  { number: 4, title: "Joy", description: "Alegria pura, explosiva, sem desculpa.", lang: "EN", energy: "anthem", flavor: "gospel", prompt: vidaPrompt("The full-body shout of a woman who has been quiet for too long, lungs open, throat free. Jumping with both feet leaving the ground", "Explosive unapologetic rapture, sacred wildness, the holy yes of a body that refuses to sit down and be reasonable", "Gospel choir at full power with organ swells and Hammond grinding, tambourines shaking, drums crashing, brass blazing, the sound of a church where everyone stands", "EN", "anthem", "gospel"), durationSeconds: 240 },
  { number: 5, title: "O Corpo Sabe", description: "O corpo sabe celebrar antes da mente concordar.", lang: "PT", energy: "pulse", flavor: "marrabenta", prompt: vidaPrompt("Hips swaying before the thought forms, feet tapping before the ear fully hears. The body's ancient knowledge of celebration — how to stomp, how to let the spine become a wave", "Instinctive physical intelligence, the body leading and the mind gratefully following. Rhythm over reason", "Marrabenta groove that makes stillness impossible, interlocking guitar patterns with bass and percussion. Body percussion — chest slaps, thigh hits, foot stamps", "PT", "pulse", "marrabenta"), durationSeconds: 240 },
  { number: 6, title: "Barefoot", description: "Descalça e sem limites, a dança final.", lang: "EN", energy: "anthem", flavor: "house", prompt: vidaPrompt("Every surface is a dance floor — grass, sand, concrete, kitchen tile. The final freedom of feet that remembered what shoes made them forget", "Limitless celebration, euphoric liberation, dancing as the most honest prayer, barefoot as the most honest state", "Anthemic house build with soaring synth chords, four-on-the-floor relentlessly upward, gospel vocal samples over the drop, marrabenta guitar woven in, pure euphoric release", "EN", "anthem", "house"), durationSeconds: 300 },
]);
...
const VIDA_BRASA_LENTA = vidaAlbum("vida-brasa-lenta", "Brasa Lenta", "força quieta, paciência como poder", "#A85A3A", [
  ...
  { number: 3, title: "O Tempo Certo", description: "O tempo certo, não o tempo rápido.", lang: "PT", energy: "steady", flavor: "marrabenta", prompt: vidaPrompt("Bread rising in a cloth-covered bowl, the yeast working at its own pace. The farmer who plants knowing the harvest is months away, hands in soil without urgency", "Unhurried wisdom, the deep knowing that rushing ruins what patience perfects. Grounded trust in timing", "Marrabenta at a deliberately relaxed tempo, guitar picking a melody that takes its time. Timbila keeping unhurried pulse, bass walking slowly, the groove of a Sunday afternoon", "PT", "steady", "marrabenta"), durationSeconds: 240 },
...
const VIDA_RAIZ_MUDA = vidaAlbum("vida-raiz-muda", "Raiz Muda", "crescimento invisível, o que muda no escuro", "#4A6B3A", [
  ...
  { number: 5, title: "A Primeira Folha", description: "A primeira folha a romper o solo, triunfo silencioso.", lang: "PT", energy: "steady", flavor: "marrabenta", prompt: vidaPrompt("The crack in the soil where green pushes through, the tiny impossible leaf that moved earth. The first visible sign after months of darkness — small, fragile, triumphant", "Quiet triumph, the private joy of emergence after long patience. Tender victory, vulnerability of showing yourself for the first time", "Marrabenta guitar entering with a bright clean melody after a long sparse intro, like sunlight breaking through. Timbila and gentle percussion building, bass rising", "PT", "steady", "marrabenta"), durationSeconds: 240 },
...
const VIDA_RESSONANCIA = vidaAlbum("vida-ressonancia", "Ressonância", "despertar colectivo, quando uma acorda muitas sentem", "#8B5CF6", [
  ...
  { number: 3, title: "Duas Vozes", description: "Duas vozes a encontrarem-se no escuro.", lang: "PT", energy: "steady", flavor: "marrabenta", prompt: vidaPrompt("Two women discovering they carry the same wound, the shock of recognition across a table. Two voices finding the same note by accident", "The electric relief of being seen, the warmth of 'you too?' between strangers. Doubled strength", "Two acoustic guitars in marrabenta style, playing independently then finding each other's rhythm. Two vocal lines weaving, timbila holding the centre", "PT", "steady", "marrabenta"), durationSeconds: 240 },
  { number: 4, title: "The Circle", description: "O círculo que acolhe todos os que entram.", lang: "EN", energy: "pulse", flavor: "gospel", prompt: vidaPrompt("Women standing in a circle, shoulders touching, breathing together without instruction. Bodies forming a shape with no hierarchy, everyone facing the centre", "Sacred belonging, the overwhelming emotion of being held by many at once. Pulsing collective heartbeat", "Gospel choir building from unison to full harmony, organ chords swelling. Handclaps and tambourine driving a collective heartbeat, bass drum on every beat", "EN", "pulse", "gospel"), durationSeconds: 240 },
