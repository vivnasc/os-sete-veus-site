        ...
        <div className="grid grid-cols-4 gap-3 mb-6">
          {typeof navigator !== "undefined" && typeof navigator.share === "function" && (
            ...
            >
              ...
              <span className="text-[10px] text-[#a0a0b0]">Partilhar</span>
            </button>
          )}
          ...
          >
            ...
            <span className="text-[10px] text-[#a0a0b0]">WhatsApp</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] text-[#a0a0b0]">Instagram</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] text-[#a0a0b0]">X</span>
          </button>
        </div>
